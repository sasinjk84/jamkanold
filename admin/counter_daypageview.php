...
<table cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td height="29" colspan="3">
			<table cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td height="28" class="link" align="left" background="images/con_link_bg.gif"><img src="images/top_link_house.gif" border="0" valign="absmiddle">현재위치 : 통계분석 &gt; 트래픽 분석 &gt; <span class="2depth_select">일자별 페이지뷰</span></td>
			</tr>
			</table>
		</td>
	</tr>
...
<?}?>
			<tr>
				...
				<TR>
					<TD><IMG SRC="images/counter_daypageview_title.gif"  ALT=""></TD>
					</tr>
<tr>
...
<?
				if($searchdate>=date("Ym",mktime(0,0,0,date("m")-1,date("d"),date("Y")))) {
					$sql ="SELECT MID(date,7,2) as day,sum(pagecnt) as pagecnt FROM tblcounter ";
					$sql.="WHERE date LIKE '".$searchdate."%' GROUP BY day ";
				} else {	//1달 후 데이터는 월 데이타 테이블에서 찾는다.
					$sql ="SELECT MID(date,7,2) as day, pagecnt FROM tblcountermonth ";
			...
			<tr>
				...
				<TR>
					...
					<tr>
						...
						<td><FONT color=#3d3d3d>일자별 쇼핑몰 페이지뷰 숫자를 보여 드리고 있습니다.</FONT></td>
					</tr>
					<tr><td colspan=2 height=5></td></tr>
					<tr>
						<td width="20" align="right" valign="top"><img src="images/icon_8.gif" width="13" height="18" border="0"></td>
						<td>
							<FONT color=#3d3d3d>일일 단위로 페이지뷰 숫자를 1달 기준으로 보여 드리고 있습니다.<br>
							일일 페이지뷰 숫자와 일자별 요일별 페이지뷰 추이를 파악할 수 있습니다.</FONT>
						</td>
					</tr>
					<tr><td colspan=2 height=5></td></tr>
					<tr>
						<td width="20" align="right" valign="top"><img src="images/icon_8.gif" width="13" height="18" border="0"></td>
						<td>
							<FONT color=#3d3d3d>주간 및 주말의 일평균 페이지뷰의 숫자추이를 분석하여 마케팅도구로 활용할 수 있습니다.<br>
							예를 들면, 주간 일평균 페이지뷰과 52,000~53,000에서 움직이고 있는 데,<br>
							특정 평일의 페이지뷰과 일평균보다 높은 59,000을 나타내고 있다면, <br>
							이 날의 쇼핑몰에서의 특별한 마케팅(신규상품 등록, 컨텐츠 갱신, 할인행사 등) 요소를 추출하여,<br>
							마케팅 결과 및 효과를 파악할 수 있습니다.<br>
							특히, 쇼핑몰 업그레이드 등 컨텐츠의 마케팅 효과에 대한 평가도구로써 유용한 데이터입니다.</FONT>
						</td>
					</tr>
					</table>
					</TD>
