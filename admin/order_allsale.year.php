...
$sql.= "substring(a.ordercode,1,6) as month FROM tblorderinfo a ";
...
for($i=1;$i<=12;$i++) {
	...
	echo "	</td>\n";
	echo "	<td></td>\n";
	echo "	<td align=\"center\"><img src=\"./images/btn_productaverage.gif\" style=\"cursor:pointer;\" onclick=\"allsaleProduct('".$i."');\"></td>\n";
	echo "</tr>\n";
...
<TR>
	...
	<td></td>
	<TD background="images/table_con_line1.gif"></TD>
</TR>
<tr>
	...
	<td></td>
	<td align="center"><img src="./images/btn_productaverage.gif" style="cursor:pointer;" onclick="allsaleProduct('all');"></td>
</tr>
<TR>
	<TD background="images/table_con_line1.gif" width="80"><img src="images/table_con_line1.gif" width="4" height="1" border="0"></TD>
	<TD background="images/table_con_line1.gif" width="680" colspan="2"></TD>
