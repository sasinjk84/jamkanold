...
<tr>
	...
	<TR>
		<TD><IMG <?if($sch=="AD")echo"SRC=\"images/img_tapstart.gif\""; else echo"SRC=\"images/img_tapstartr.gif\"";?> WIDTH=10 HEIGHT=30 ALT=""></TD>
		<TD width="202" <?if($sch=="AD")echo"background=\"images/img_tapbg.gif\" class=\"font_white\""; else echo"background=\"images/img_tapbgr.gif\"";?>><input type=radio id="idx_sch0" name="sch" value="AD" <?if($sch=="AD")echo"checked";?> style="BORDER-RIGHT: medium none; BORDER-TOP: medium none; BORDER-LEFT: medium none; BORDER-BOTTOM: medium none;" onclick="SkinList()"> <label style='cursor:hand; TEXT-DECORATION: none;' onmouseover="style.textDecoration='underline'" onmouseout="style.textDecoration='none'" for=idx_sch0>일반 쇼핑몰 디자인 타입</label></TD>
		<TD><IMG <?if($sch=="AD")echo"SRC=\"images/img_tap_end.gif\""; else echo"SRC=\"images/img_tap_endr.gif\"";?> WIDTH=10 HEIGHT=30 ALT=""></TD>
		<TD><IMG <?if($sch=="BD")echo"SRC=\"images/img_tapstart.gif\""; else echo"SRC=\"images/img_tapstartr.gif\"";?> WIDTH=10 HEIGHT=30 ALT=""></TD>
		<TD width="202" <?if($sch=="BD")echo"background=\"images/img_tapbg.gif\" class=\"font_white\""; else echo"background=\"images/img_tapbgr.gif\"";?>><input type=radio id="idx_sch1" name="sch" value="BD" <?if($sch=="BD")echo"checked";?> style="BORDER-RIGHT: medium none; BORDER-TOP: medium none; BORDER-LEFT: medium none; BORDER-BOTTOM: medium none;" onclick="SkinList()"> <label style='cursor:hand; TEXT-DECORATION: none;' onmouseover="style.textDecoration='underline'" onmouseout="style.textDecoration='none'" for=idx_sch1>가격 고정형 디자인 타입</label></TD>
		<TD><IMG <?if($sch=="BD")echo"SRC=\"images/img_tap_end.gif\""; else echo"SRC=\"images/img_tap_endr.gif\"";?> WIDTH=10 HEIGHT=30 ALT=""></TD>
	</TR>
	</TABLE>
	</TD>
</tr>
<tr>
	...
	<tr>
		...
		<tr>
			...
			<TR>
				<TD width="100%" align=center height="30"  background="images/blueline_bg.gif"><b><font color="#555555">템플릿 선택하기</font></b></TD>
			</TR>
			<TR>
				<TD width="100%" background="img/table_con_line.gif"></TD>
			</TR>
			<TR>
...
<?
	...
	while($row=mysql_fetch_object($result)) {
		...
		echo "<img src=\"images/product/".$row->code.".gif\" width=\"150\" height=\"160\" border=\"0\" class=\"imgline1\" onMouseOver='changeMouseOver(this);' onMouseOut=\"changeMouseOut(this,'dotted #FFFFFF');\" style='cursor:hand;' onclick='ChangeDesign(".$i.");'>";
...
<?
	...
	if (ceil($t_count/$setup[list_num]) > 0) {
		...
		$a_first_block = "";
		if ($nowblock > 0) {
			$a_first_block .= "<a href='javascript:GoPage(0,1);' onMouseOut=\"window.status='';return true\" onMouseOver=\"window.status='첫 페이지';return true\" align=\"absmiddle\"><IMG src=\"img/icon_first.gif\" border=0 align=\"absmiddle\"></a>&nbsp;&nbsp;";
		...
		if ((intval($total_block) > 0) && (intval($nowblock) < intval($total_block))) {
			...
			$a_last_block .= "&nbsp;&nbsp;<a href='javascript:GoPage(".$last_block.",".$last_gotopage.");' onMouseOut=\"window.status='';return true\" onMouseOver=\"window.status='마지막 페이지';return true\" align=\"absmiddle\"><IMG src=\"img/icon_last.gif\" border=0 align=\"absmiddle\" width=\"17\" height=\"14\"></a>";
