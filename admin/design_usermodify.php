...
if($type=="update" && strlen($design)==3) {
	...
	$onload="<script>alert(\"회원정보수정 화면 템플릿 설정이 완료되었습니다.\");</script>";
}
...
<table cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td height="29" colspan="3">
			<table cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td height="28" class="link" align="left" background="images/con_link_bg.gif"><img src="images/top_link_house.gif" border="0" valign="absmiddle">현재위치 : 디자인관리 &gt; 템플릿-페이지 본문  &gt; <span class="2depth_select">회원수정 화면 템플릿</span></td>
			</tr>
			</table>
		</td>
	</tr>   
        ...
        <td bgcolor="#ffffff" style="padding:10px">
			...
			<tr>
				<td>
					<TABLE WIDTH="100%" BORDER=0 CELLPADDING=0 CELLSPACING=0>
						<TR>
							<TD><IMG SRC="images/design_usermodify_title.gif" ALT=""></TD>
						</tr>
						<tr>
			...
			<tr>
				...
				<TR>
					...
					<TD width="100%" class="notice_blue">쇼핑몰 회원정보수정 화면 디자인을 선택하여 사용하실 수 있습니다.</TD>
			...
			<tr>
				<td align=center width="764"><img id="preview_img" src="images/sample/mbmodify<?=$_shopdata->design_mbmodify?>.gif" border=0 width=200 class="imgline"></td>
			</tr>
			<tr><td height="10"></td></tr>
			<tr>
...
<?
		for($i=0;$i<count($templet_list);$i++) {
			...
			echo "<img src=\"images/sample/mbmodify".$templet_list[$i].".gif\" width=\"150\" height=\"160\" border=\"0\" class=\"imgline1\" onMouseOver='changeMouseOver(this);' onMouseOut=\"changeMouseOut(this,'dotted #FFFFFF');\" style='cursor:hand;' onclick='ChangeDesign(".$i.");'>";
			...
			<tr>
				...
				<TR>
					...
					<tr>
						...
						<td width="100%"><span class="font_dotline">회원수정 템플릿 관련파일</span></td>
					</tr>
					<tr>
						...
						<td width="100%" class="space_top">
							...
							- <span class="font_orange">템플릿 파일 : /templet/mbmodify/mbmodify001.php, /templet/mbmodify/mbmodify002.php, /templet/mbmodify/mbmodify003.php</span><br />
							- <span class="font_orange">관련 파일 : /front/mypage_usermodify.php</span>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td width="20" align="right">&nbsp;</td>
						<td width="100%" class="space_top" style="letter-spacing:-0.5pt;">- <a href="javascript:parent.topframe.GoMenu(2,'design_eachusermodify.php');"><span class="font_blue">디자인관리 > 개별디자인 - 페이지 본문 > 회원수정 화면 꾸미기</span></a> 에서 개별 디자인을 할 수 있습니다.</td>
					</tr>
					<tr>
						<td width="20" align="right">&nbsp;</td>
