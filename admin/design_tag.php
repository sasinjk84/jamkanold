...
if($type=="update" && strlen($design)==3 && preg_match("/^(1|2){1}/", $code)) {
	if($code=="1") {
		...
		$onload="<script>alert(\"인기태그 화면 템플릿 설정이 완료되었습니다.\");</script>";
	} else if($code=="2") {
		...
		$onload="<script>alert(\"태그검색 화면 템플릿 설정이 완료되었습니다.\");</script>";
	}
}
...
<table cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td height="29" colspan="3">
			<table cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td height="28" class="link" align="left" background="images/con_link_bg.gif"><img src="images/top_link_house.gif" border="0" valign="absmiddle">현재위치 : 디자인관리 &gt; 템플릿-페이지 본문 &gt; <span class="2depth_select">태그 화면 템플릿</span></td>
			</tr>
			</table>
		</td>
	</tr>   
    ...
    <tr>
        ...
        <td bgcolor="#ffffff" style="padding:10px">
			...
			<tr>
				...
				<TR>
					<TD><IMG SRC="images/design_tag_title.gif" ALT=""></TD>
					</tr>
<tr>
<TD width="100%" background="images/title_bg.gif" height="21"></TD>
			...
			<tr>
				...
				<TR>
					...
					<TD width="100%" class="notice_blue">인기태그 및 태그검색 화면 디자인을 선택하여 사용하실 수 있습니다.</TD>
			...
			<tr>
				...
				<TABLE WIDTH="100%" BORDER=0 CELLPADDING=0 CELLSPACING=0>
				<TR>
					<TD><IMG SRC="images/design_tag_stitle1.gif" WIDTH="192" HEIGHT=31 ALT=""></TD>
			...
			<tr>
				...
				<TR>
					<TD class="table_cell" width="139"><img src="images/icon_point2.gif" width="8" height="11" border="0">태그 화면 선택</TD>
			...
			<tr>
				<td align=center width="764"><img id="preview_img" src="images/sample/<?=$img_gbn.$design?>.gif" border=0 width=200 class="imgline"></td>
			</tr>
...
<?
		for($i=0;$i<count($templet_list);$i++) {
			...
			echo "<img src=\"images/sample/$img_gbn".$templet_list[$i].".gif\" width=\"150\" height=\"160\" border=\"0\" class=\"imgline1\" onMouseOver='changeMouseOver(this);' onMouseOut=\"changeMouseOut(this,'dotted #FFFFFF');\" style='cursor:hand;' onclick='ChangeDesign(".$i.");'>";
			...
			<tr>
				...
				<TR>
					...
					<tr>
						...
						<td width="100%"><span class="font_dotline">태그 템플릿/관련 파일</span></td>
					</tr>
					<tr>
						...
						<td width="100%" class="space_top">
							...
							- <span class="font_orange">템플릿 파일 : /templet/tag/tag001.php, /templet/tag/tag002.php, /templet/tag/tag003.php</span><br />
							- <span class="font_orange">관련 파일 : /front/tag.php</span>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td width="20" align="right" valign="top"><img src="images/icon_8.gif" width="13" height="18" border="0"></td>
						<td width="100%"><span class="font_dotline">인기태그 등록 방법</span></td>
					</tr>
					<tr>
						<td width="20" align="right">&nbsp;</td>
						<td width="100%" class="space_top" style="letter-spacing:-0.5pt;">- 고객이 태그 검색폼에서 검색한 태그만 등록됩니다. (상품에 입력한 태그 중 인기태그화면에서 검색한 태그만 등록됩니다.)<br>
						<b>&nbsp;&nbsp;</b>단, 검색한 태그로 제품이 등록되지 않은 태그는 인기태그에 등록되지 않습니다.</td>
					</tr>
					<tr>
						<td width="20" align="right">&nbsp;</td>
						<td width="100%" class="space_top" style="letter-spacing:-0.5pt;">- <b>인기태그 등록시점</b> : 검색한 태그들은 다음날 인기태그에 등록됩니다.</td>
					</tr>
					<tr>
						<td height="20" colspan="2"></td>
					</tr>
					...
					<tr>
						<td width="20" align="right">&nbsp;</td>
						<td width="100%" class="space_top" style="letter-spacing:-0.5pt;">- <a href="javascript:parent.topframe.GoMenu(2,'design_eachtag.php');"><span class="font_blue">디자인관리 > 개별디자인 - 페이지 본문 > 태그 화면 꾸미기</span></a> 에서 개별 디자인을 할 수 있습니다.</td>
					</tr>
					<tr>
						<td width="20" align="right">&nbsp;</td>
