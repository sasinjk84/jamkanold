...
$s_date=$_POST["s_date"];
if(strlen($s_date)==0) $s_date="ordercode";
...
/*
if ($termday>31) {
	echo "<script>alert('배송/입금별 주문조회 기간은 1달을 초과할 수 없습니다.');location='".$_SERVER[PHP_SELF]."';</script>";
	exit;
}
*/
...
if($search_s) {
	if(substr($search_s,0,8)==substr($search_e,0,8)) {
		$qry.= "WHERE a.".$s_date." LIKE '".substr($search_s,0,8)."%' ";
	} else {
		$qry.= "WHERE a.".$s_date.">='".$search_s."' AND a.".$s_date." <='".$search_e."' ";
	}
}
else $qry.="WHERE a.ordercode!='' ";
if(strlen($paymethod)>0)	$qry.= "AND a.paymethod LIKE '".$paymethod."%' ";
    ...
    <tr>
        ...
        <td bgcolor="#ffffff" style="padding:10px">
			...
			<tr>
				...
				<TR>
					<TD><IMG SRC="images/order_delisearch_title.gif" ALT=""></TD>
					</tr><tr>
			...
			<tr>
				...
				<TR>
					...
					<TD width="100%" class="notice_blue">입금일별, 배송일자별, 주문일자별 주문현황 및 주문내역을 확인/처리하실 수 있습니다.</TD>
...
?>
						...
						<TR>
							<TD class="table_cell" width="139"><img src="images/icon_point5.gif" width="8" height="11" border="0">처리기준</TD>
							<TD class="td_con1" >
							<input type=radio id="idx_sdate1" name=s_date value="bank_date" <?if($s_date=="bank_date")echo"checked";?>><label style='cursor:hand;' onmouseover="style.textDecoration='underline'" onmouseout="style.textDecoration='none'" for=idx_sdate1><B>입금일자</B></label>
							<img width=5 height=0>
							<input type=radio id="idx_sdate2" name=s_date value="deli_date" <?if($s_date=="deli_date")echo"checked";?>><label style='cursor:hand;' onmouseover="style.textDecoration='underline'" onmouseout="style.textDecoration='none'" for=idx_sdate2><B>배송일자</B></label>
							<img width=5 height=0>
							<input type=radio id="idx_sdate3" name=s_date value="ordercode" <?if($s_date=="ordercode")echo"checked";?>><label style='cursor:hand;' onmouseover="style.textDecoration='underline'" onmouseout="style.textDecoration='none'" for=idx_sdate3><B>주문일자</B></label></TD>
						</TR>
						<TR>
							<TD colspan="2" background="images/table_con_line.gif"></TD>
						</TR>
			...
			<tr>
				<td style="padding-top:4pt;" align="right"><a href="javascript:searchForm();"><img src="images/botteon_search.gif" width="113" height="38" border="0"></a>&nbsp;<!-- <a href="javascript:OrderExcel();"><img src="images/btn_excel1.gif" width="127" height="38" border="0" hspace="1"></a> --></td>
			</tr>
			</form>
			<tr>
				<td height="20"></td>
...
?>
			...
			<tr>
				...
				<TR>
					...
					<tr>
						<td width="20" align="right" valign="top"><img src="images/icon_8.gif" width="13" height="18" border="0"></td>
						<td ><span class="font_dotline">배송/입금일별 주문조회 부가기능</span></td>
					</tr>
					<tr>
						<td width="20" align="right">&nbsp;</td>
					...
					<tr>
						<td width="20" align="right" valign="top"><img src="images/icon_8.gif" width="13" height="18" border="0"></td>
						<td ><span class="font_dotline">배송/입금일별 주문조회 주의사항</span></td>
					</tr>
					<tr>
						<td width="20" align="right">&nbsp;</td>
						<td  class="space_top">- 배송/입금별 주문조회 기간은 1달을 초과할 수 없습니다.</td>
					</tr>
					</table>
					</TD>
