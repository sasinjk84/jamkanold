...
<table cellpadding="0" cellspacing="0" width="100%">
	...
	?>
			...
			<tr>
				...
				<TR>
					<TD width="100" bgcolor="#F0FDFF" height="30" background="images/blueline_bg.gif"><p align="center"><b><font color="#0099CC">시간</font></b></TD>
					<TD class="td_con1" width="627" bgcolor="#F0FDFF" background="images/blueline_bg.gif"><p align="center"><b><font color="#0099CC">오늘의 할일</font></b></TD>
				</TR>
				<TR>
				...
				<TR>
					<TD class="table_cell" width="100"><p align="center"><FONT class=smallfont><B><span style="letter-spacing:0;">시간미지정 <a style="CURSOR:hand;" onClick="OpenWindow('community_schedule_add.php?year=<?=$year?>&month=<?=$month?>&day=<?=$day?>',350,130,'no','schedule')"><img src="images/icon_date_add.gif" width="16" height="16" border="0" hspace="2" align=absmiddle></a></span></B></FONT></TD>
 ...
 class="menual_bg">
					...
					<tr>
						...
						<td><span class="font_dotline">쇼핑몰 일정관리(DAY)</span></td>
					</tr>
					<tr>
						<td align="right">&nbsp;</td>
						<td class="space_top" style="letter-spacing:-0.5pt;">- 일(Day) 단위로 쇼핑몰 주요 일정이 출력됩니다.</td>
					</tr>
					<tr>
						<td align="right">&nbsp;</td>
