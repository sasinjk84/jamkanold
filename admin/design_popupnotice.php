...
if($type=="update" && strlen($design)==3) {
	if($_shopdata->design_notice!=$design) {
		$sql = "UPDATE tblshopinfo SET design_notice='".$design."' ";
		mysql_query($sql,get_db_conn());
		DeleteCache("tblshopinfo.cache");

		$_shopdata->design_notice=$design;
	}
	$onload="<script>alert(\"공지사항 팝업창 템플릿 설정이 완료되었습니다.\");</script>";
}
...
function design_preview(design) {
	document.all["preview_img"].src="images/sample/notice"+design+".gif";
}
...
<table cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td height="29" colspan="3">
			<table cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td height="28" class="link" align="left" background="images/con_link_bg.gif"><img src="images/top_link_house.gif" border="0" valign="absmiddle">현재위치 : 디자인관리 &gt; 템플릿-페이지 본문  &gt; <span class="2depth_select">공지사항 팝업창 템플릿</span></td>
			</tr>
			</table>
		</td>
	</tr>   
    ...
    <tr>
        ...
        <td bgcolor="#ffffff" style="padding:10px">
			...
			<tr>
				...
				<TR>
					<TD><IMG SRC="images/design_popupnotice_title.gif" ALT=""></TD>
					</tr>
<tr>
<TD width="100%" background="images/title_bg.gif" height="21"></TD>
			...
			<tr>
				...
				<TR>
					...
					<TD width="100%" class="notice_blue">쇼핑몰 공지사항 팝업창 디자인을 선택하여 사용하실 수 있습니다.</TD>
			...
			<tr>
				<td align=center width="764"><img id="preview_img" src="images/sample/notice<?=$_shopdata->design_notice?>.gif" width="200" border="0" class="imgline"></td>
			</tr>
			<tr><td height="10"></td></tr>
			<tr>
...
<?
		for($i=0;$i<count($templet_list);$i++) {
			...
			echo "<img src=\"images/sample/notice".$templet_list[$i].".gif\" width=\"150\" height=\"160\" border=\"0\" class=\"imgline1\" onMouseOver='changeMouseOver(this);' onMouseOut=\"changeMouseOut(this,'dotted #FFFFFF');\" style='cursor:hand;' onclick='ChangeDesign(".$i.");'>";
			echo "<br><input type=radio id=\"idx_design".$i."\" name=design value=\"".$templet_list[$i]."\" ";
			if($_shopdata->design_notice==$templet_list[$i]) echo "checked";
			...
			<tr>
				...
				<TR>
					...
					<tr>
						...
						<td width="100%"><span class="font_dotline">공지사항 팝업창 템플릿/관련 파일</span></td>
					</tr>
					<tr>
						...
						<td width="100%" class="space_top">
							...
							- <span class="font_orange">템플릿 파일(목록) : /templet/notice/noticelist001.php, /templet/notice/noticelist002.php, /templet/notice/noticelist003.php</span><br />
							- <span class="font_orange">템플릿 파일(보기) : /templet/notice/noticeview001.php, /templet/notice/noticeview002.php, /templet/notice/noticeview003.php</span><br />
							- <span class="font_orange">관련 파일 : /front/notice.php</span>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td width="20" align="right">&nbsp;</td>
						<td width="100%" class="space_top" style="letter-spacing:-0.5pt;">- <a href="javascript:parent.topframe.GoMenu(2,'design_eachpopupnotice.php');"><span class="font_blue">디자인관리 > 개별디자인 - 페이지 본문 > 공지사항 팝업창 꾸미기</span></a> 에서 개별 디자인을 할 수 있습니다.</td>
					</tr>
					<tr>
						<td width="20" align="right">&nbsp;</td>
