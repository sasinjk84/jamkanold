...
<table cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td height="29" colspan="3">
			<table cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td height="28" class="link" align="left" background="images/con_link_bg.gif"><img src="images/top_link_house.gif" border="0" valign="absmiddle">현재위치 : 상품관리 &gt; 관련상품 관리 &gt; <span class="2depth_select">관련상품 검색/등록</span></td>
			</tr>
			</table>
		</td>
	</tr>
    ...
    <tr>
        ...
        <td bgcolor="#ffffff" style="padding:10px">
			...
			<tr>
				...
				<TR>
					<TD><IMG SRC="images/product_collectionlist_titl.gif" ALT=""></TD>
					</tr><tr>
			...
			<tr>
				...
				<TR>
					...
					<TD width="100%" class="notice_blue">상품 상세페이지에 보여질 관련상품 등록/삭제할 수 있습니다.</TD>
			...
			<tr>
				...
				<TR>
					...
					<tr>
						...
						<td><span class="font_dotline">관련상품 검색/등록 주의사항</span></td>
					</tr>
					<tr>
						<td align="right">&nbsp;</td>
						<td class="space_top">- 분류별 관련상품 목록은 해당 카테고리내 모든 상품에게 동일하게 관련상품이 적용됩니다.</td>
					</tr>
					<tr>
						<td align="right">&nbsp;</td>
						<td class="space_top">- 상품별 관련상품 목록은 분류별 관련상품이 등록돼 있더라도 무시하고 출력됩니다.</td>
					</tr>
					<tr>
						<td align="right">&nbsp;</td>
						<td class="space_top">- 관련상품 출력은 관련상품 진열방식 설정 에서 [관련상품 진열여부]에서 "관련상품 진열함"을 선택해야만 출력됩니다.<br>
						<b>&nbsp;&nbsp;</b><a href="javascript:parent.topframe.GoMenu(4,'product_collectionconfig.php');"><span class="font_blue">상품관리 > 관련상품 관리 > 관련상품 진열방식 설정</span></a></td>
					</tr>
					<tr>
					...
					<tr>
						<td align="right" valign="top"><img src="images/icon_8.gif" width="13" height="18" border="0"></td>
						<td><span class="font_dotline">카테고리별 관련상품 등록하기</span></td>
					</tr>
					<tr>
						<td align="right">&nbsp;</td>
						<td class="space_top">① 관련상품을 등록할 카테고리를 선택합니다.</td>
					</tr>
					<tr>
						<td align="right">&nbsp;</td>
						<td class="space_top">② [등록할 관련상품 검색하기]를 클릭 후 해당 등록창에서 관련상품을 등록합니다.</td>
					</tr>
					<tr>
						<td align="right">&nbsp;</td>
						<td class="space_top">③ 분류별 관련상품 목록에서 등록된 관련상품을 확인할 수 있습니다.</td>
					</tr>
					<tr>
						<td colspan="2" height="20"></td>
					</tr>
					<tr>
						<td align="right" valign="top"><img src="images/icon_8.gif" width="13" height="18" border="0"></td>
						<td><span class="font_dotline">상품별 관련상품 등록하기</span></td>
					</tr>
					<tr>
						<td align="right">&nbsp;</td>
						<td class="space_top">① 관련상품을 등록할 카테고리를 선택합니다.</td>
					...
					<tr>
						<td align="right">&nbsp;</td>
						<td class="space_top">② 카테고리내 상품목록에서 관련상품을 등록할 상품을 선택합니다.</td>
					</tr>
					<tr>
						<td align="right">&nbsp;</td>
						<td class="space_top">③ [등록할 관련상품 검색하기]를 클릭 후 해당 등록창에서 관련상품을 등록합니다.</td>
					...
					<tr>
						<td align="right">&nbsp;</td>
						<td class="space_top">④ 상품별 관련상품 목록 > 선택된 상품에 등록된 관련상품목록에서 등록된 관련상품을 확인할 수 있습니다.</td>
					</tr>
					</table>
					</TD>
