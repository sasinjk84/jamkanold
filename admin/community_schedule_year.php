...
<table cellpadding="0" cellspacing="0" width="100%">
    ...
    <tr>
		...
		?>
					...
					<tr>
						<td class="<?=$tr_class_str?>" align=center valign=top background="images/blueline_bg.gif"><a href='community_schedule_month.php?year=<?=$year?>&month=<?=$inputM?>&day=<?=$day?>'><b><font color="#0099CC"><?= $inputM ?>월</font></b></a></td>
					</tr>
					<tr>
			...
			<tr>
				...
				<TR>
					...
					<tr>
						...
						<td><span class="font_dotline">쇼핑몰 일정관리(YEAR)</span></td>
					</tr>
					<tr>
						<td align="right">&nbsp;</td>
						<td class="space_top" style="letter-spacing:-0.5pt;">- 년(Year) 단위로 쇼핑몰 주요 일정이 출력됩니다.</td>
					</tr>
					<tr>
						<td align="right">&nbsp;</td>
