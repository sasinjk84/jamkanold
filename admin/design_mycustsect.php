...
<table cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td height="29" colspan="3">
			<table cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td height="28" class="link" align="left" background="images/con_link_bg.gif"><img src="images/top_link_house.gif" border="0" valign="absmiddle">현재위치 : 디자인관리 &gt; 템플릿-페이지 본문  &gt; <span class="2depth_select">단골매장 화면 템플릿</span></td>
			</tr>
			</table>
		</td>
	</tr>   
    ...
    <tr>
        ...
        <td bgcolor="#ffffff" style="padding:10px">
			...
			<tr>
				...
				<TR>
					<TD><IMG SRC="images/design_mycustsect_title.gif" ALT=""></TD>
					</tr><tr>
			...
			<tr>
				<td align=center width="764"><img id="preview_img" src="images/sample/mycustsect<?=$_shopdata->design_mycustsect?>.gif" width="200" border="0" class="imgline"></td>
			</tr>
			<tr><td height="10"></td></tr>
			<tr>
				...
				<tr>
					...
					<tr>
						...
						<TR>
							<TD width="100%" height="30" align=center background="images/blueline_bg.gif"><b><font color="#333333">템플릿 적용하기</font></b></TD>
						</TR>
						<TR>
			...
			<tr>
				...
				<TR>
					...
					<tr>
						...
						<td width="100%"><span class="font_dotline">단골매장 템플릿/관련 파일</span></td>
					</tr>
					<tr>
						...
						<td width="100%" class="space_top">
							...
							- <span class="font_orange">템플릿 파일 : /templet/mycustsect/mycustsect001.php, /templet/mycustsect/mycustsect002.php, /templet/mycustsect/mycustsect003.php</span><br />
							- <span class="font_orange">관련 파일 : /front/mypage_custsect.php</span>
						</td>
					</tr>
					<tr>
