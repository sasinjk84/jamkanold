...
<table cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td height="29" colspan="3">
			<table cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td height="28" class="link" align="left" background="images/con_link_bg.gif"><img src="images/top_link_house.gif" border="0" valign="absmiddle">ÇöÀçÀ§Ä¡ : ¸¶ÄÉÆÃÁö¿ø &gt; ÀÌº¥Æ®/»çÀºÇ° ±â´É ¼³Á¤ &gt; <span class="2depth_select">ºê·£µåº° ÀÌº¥Æ® °ü¸®</span></td>
			</tr>
			</table>
		</td>
	</tr>   
...
<TD width="100%" background="images/title_bg.gif" height="21"></TD>
			...
			<tr>
				...
				<TR>
					...
					<TD width="100%" class="notice_blue">°¢ ºê·£µåº° ÆäÀÌÁö »ó´Ü¿¡ ÀÌ¹ÌÁö ¶Ç´Â Html ÆíÁýÀ» ÅëÇØ ÀÌº¥Æ®¸¦ °ü¸® ÇÏ½Ç ¼ö ÀÖ½À´Ï´Ù.</TD>
						...
						<tr>
							...
							<?
								...
								if(strlen($brandopt)>0) {
									$brandopt = "<option value=\"".$seachIdx."\">---- ".$seachIdx." ºê·£µå ÀÏ°ý Àû¿ë ----</option>\n".$brandopt;
								}
								echo $brandopt;
							?>
										</select></td>
										...
										<tr><td align="center" style="font-size:14px;line-height:21px;"><b><a href="javascript:SearchSubmit('¤±');"><span id="¤±">¤±</span></a></b></td></tr>
										<tr><td align="center" style="font-size:14px;line-height:21px;"><b><a href="javascript:SearchSubmit('¤²');"><span id="¤²">¤²</span></a></b></td></tr>
										<tr><td align="center" style="font-size:14px;line-height:21px;"><b><a href="javascript:SearchSubmit('¤µ');"><span id="¤µ">¤µ</span></a></b></td></tr>
										<tr><td align="center" style="font-size:14px;line-height:21px;"><b><a href="javascript:SearchSubmit('¤·');"><span id="¤·">¤·</span></a></b></td></tr>
										<tr><td align="center" style="font-size:14px;line-height:21px;"><b><a href="javascript:SearchSubmit('¤¸');"><span id="¤¸">¤¸</span></a></b></td></tr>
										<tr><td align="center" style="font-size:14px;line-height:21px;"><b><a href="javascript:SearchSubmit('¤º');"><span id="¤º">¤º</span></a></b></td></tr>
										<tr><td align="center" style="font-size:14px;line-height:21px;"><b><a href="javascript:SearchSubmit('¤»');"><span id="¤»">¤»</span></a></b></td></tr>
										<tr><td align="center" style="font-size:14px;line-height:21px;"><b><a href="javascript:SearchSubmit('¤¼');"><span id="¤¼">¤¼</span></a></b></td></tr>
										<tr><td align="center" style="font-size:14px;line-height:21px;"><b><a href="javascript:SearchSubmit('¤½');"><span id="¤½">¤½</span></a></b></td></tr>
										<tr><td align="center" style="font-size:14px;line-height:21px;"><b><a href="javascript:SearchSubmit('¤¾');"><span id="¤¾">¤¾</span></a></b></td></tr>
										<tr><td align="center" style="line-height:21px;"><b><a href="javascript:SearchSubmit('±âÅ¸');"><span id="±âÅ¸">±âÅ¸</span></a></b></td></tr>
										</table>
										</td>
									</tr>
									</table>
			...
			<tr>
				...
				<TR>
					...
					<tr>
						...
						<td><span class="font_dotline">ºê·£µåº° ÀÌº¥Æ® °ü¸®</span></td>
					</tr>
					<tr>
						<td align="right">&nbsp;</td>
						<td class="space_top">- ÀÌ¹ÌÁö ¶Ç´Â Html ÆíÁýÀ» ÇÏ½Ã¸é °¢ ºê·£µå »ó´ÜÀ» ´Ù¾çÇÏ°Ô ²Ù¹Ì½Ç ¼ö ÀÖ½À´Ï´Ù.</td>
					</tr>
					<tr>
						<td align="right">&nbsp;</td>
						<td class="space_top">- ºê·£µåº° ÀÌº¥Æ®´Â "»óÇ° ºê·£µå ÅÛÇÃ¸´" »ç¿ë½Ã¿¡¸¸ Ãâ·ÂµË´Ï´Ù.<br>
						<b>&nbsp;&nbsp;</b><a href="javascript:parent.topframe.GoMenu(2,'design_blist.php');"><span class="font_blue">µðÀÚÀÎ °ü¸® > ÅÛÇÃ¸´-¸ÞÀÎ ¹× Ä«Å×°í¸® > »óÇ° ºê·£µå ÅÛÇÃ¸´</span></a></td>
					</tr>
					<tr>
						<td align="right">&nbsp;</td>
						<td class="space_top">- °³º° µðÀÚÀÎ »ç¿ë½Ã "»óÇ° ºê·£µå È­¸é ²Ù¹Ì±â"¿¡¼­ ÇØ´ç ¸ÅÅ©·Î¸¦ ÀÌ¿ëÇÏ½Ã¸é Ãâ·ÂÀÌ °¡´ÉÇÕ´Ï´Ù.<br>
						<b>&nbsp;&nbsp;</b><a href="javascript:parent.topframe.GoMenu(2,'design_eachblist.php');"><span class="font_blue">µðÀÚÀÎ °ü¸® > °³º°µðÀÚÀÎ-ÆäÀÌÁö º»¹® > »óÇ°ºê·£µå È­¸é ²Ù¹Ì±â</span></a></td>
					</tr>
					</table>
					</TD>
