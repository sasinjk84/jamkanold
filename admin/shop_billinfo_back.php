        ...
        <td bgcolor="#ffffff" style="padding:10px">
			...
			<tr>
				...
				<TR>
					...
					<tr>
						<td width="20" align="right">&nbsp;</td>
						<td  class="space_top">연동처리후 자동등록되며, 실제 발행처리는 가비아 하이웍스에서 발행하셔야 합니다.</td>
					</tr>
					<tr>
						<td width="20" align="right">&nbsp;</td>
						<td  class="space_top">연동정보의 경우 http://hiworks.co.kr 에서 확인 가능합니다.(하이웍스 개설 오피스주소,사용자 ID,연동 KEY) </td>
					</tr>
					</table>
					</TD>
