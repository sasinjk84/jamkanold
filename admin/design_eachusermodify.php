...
if($type=="update" && strlen($body)>0) {
	...
	$onload="<script>alert(\"회원정보수정 화면 디자인 수정이 완료되었습니다.\");</script>";
} else if($type=="delete") {
	...
	mysql_query($sql,get_db_conn());
	DeleteCache("tblshopinfo.cache");
	$onload="<script>alert(\"회원정보수정 화면 디자인 삭제가 완료되었습니다.\");</script>";
} else if($type=="clear") {
	$intitle="";
	$body="";
...
<table cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td height="29" colspan="3">
			<table cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td height="28" class="link" align="left" background="images/con_link_bg.gif"><img src="images/top_link_house.gif" border="0" valign="absmiddle">현재위치 : 디자인관리 &gt; 개별디자인-페이지 본문 &gt; <span class="2depth_select">회원수정 화면 꾸미기</span></td>
			</tr>
			</table>
		</td>
	</tr>
...
<TD width="100%" background="images/title_bg.gif" height="21"></TD>
			...
			<tr>
				...
				<TR>
					...
					<TD width="100%" class="notice_blue"><p>회원정보수정 화면 디자인을 자유롭게 디자인 하실 수 있습니다.</p></TD>
			...
			<tr>
				...
				<TR>
					...
					<tr>
						...
						<td><p class="LIPoint"><B><span class="font_orange">회원수정 매크로명령어</span></B>(해당 매크로명령어는 다른 페이지 디자인 작업시 사용이 불가능함)</p></td>
					</tr>
					<tr>
