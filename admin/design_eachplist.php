...
<table cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td height="29" colspan="3">
			<table cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td height="28" class="link" align="left" background="images/con_link_bg.gif"><img src="images/top_link_house.gif" border="0" valign="absmiddle">현재위치 : 디자인관리 &gt; 개별디자인-페이지 본문 &gt; <span class="2depth_select">상품 카테고리 꾸미기</span></td>
			</tr>
			</table>
		</td>
	</tr>   
    ...
    <tr>
        ...
        <td bgcolor="#ffffff" style="padding:10px">
			...
			<tr>
				...
				<TR>
					<TD><IMG SRC="images/design_productcate_title.gif"  ALT=""></TD>
					</tr>
<tr>
<TD width="100%" background="images/title_bg.gif" height="21"></TD>
			...
			<tr>
				...
				<TR>
					...
					<TD width="100%" class="notice_blue"><p>상품 카테고리별로 자유롭게 디자인을 할 수 있습니다.</p></TD>
			...
			<tr>
				...
				<TABLE WIDTH="100%" BORDER=0 CELLPADDING=0 CELLSPACING=0>
				<TR>
					<TD><IMG SRC="images/design_productcate_stitle.gif" border="0"></TD>
			...
			<tr>
				...
				<TR>
					...
					<TD class="td_con1" align="center"  style="padding:5pt;" style="letter-spacing:-0.5pt;"><img id="preview_img" style="display:none" width="150" height="184" border="0" vspace="5" class="imgline"><br><p align="left"><b>&quot;모든 카테고리 일괄 개별디자인&quot; </b>을 적용할 경우 개별 디자인 사용중인 카테고리를 제외한 템플릿을 사용하는 모든 카테고리가 개별디자인으로 일괄 변경됩니다.</TD>
				</TR>
				<TR>
					<TD background="images/table_top_line.gif" colspan="3"></TD>
				</TR>
