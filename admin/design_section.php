...
//$templet_list=array(0=>"001",1=>"002",2=>"003",3=>"004",4=>"005",5=>"006",6=>"007",7=>"008",8=>"009");
...
if($type=="update" && strlen($design)==3 && preg_match("/^(1|2|3|4){1}/", $code)) {
	if($code=="1") {
		...
		$onload="<script>alert(\"신상품 화면 템플릿 설정이 완료되었습니다.\");</script>";
	} else if($code=="2") {
		...
		$onload="<script>alert(\"인기상품 화면 템플릿 설정이 완료되었습니다.\");</script>";
	} else if($code=="3") {
		...
		$onload="<script>alert(\"추천상품 화면 템플릿 설정이 완료되었습니다.\");</script>";
	} else if($code=="4") {
		...
		$onload="<script>alert(\"특별상품 화면 템플릿 설정이 완료되었습니다.\");</script>";
	}
}
...
<table cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td height="29" colspan="3">
			<table cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td height="28" class="link" align="left" background="images/con_link_bg.gif"><img src="images/top_link_house.gif" border="0" valign="absmiddle">현재위치 : 디자인관리 &gt; 템플릿-페이지 본문  &gt; <span class="2depth_select">섹션상품 화면 템플릿</span></td>
			</tr>
			</table>
		</td>
	</tr>
    ...
    <tr>
        ...
        <td bgcolor="#ffffff" style="padding:10px">
			...
			<tr>
				...
				<TR>
					<TD><IMG SRC="images/design_section_title.gif" ALT=""></TD>
					</tr>
<tr>
<TD width="100%" background="images/title_bg.gif" height="21"></TD>
			...
			<tr>
				...
				<TR>
					...
					<TD width="100%" class="notice_blue">메인 섹션별 화면 디자인을 선택하여 사용하실 수 있습니다.</TD>
			...
			<tr>
				...
				<TABLE WIDTH="100%" BORDER=0 CELLPADDING=0 CELLSPACING=0>
				<TR>
					<TD><IMG SRC="images/design_section_stitle1.gif" WIDTH="192" HEIGHT=31 ALT=""></TD>
			...
			<tr>
				...
				<TR>
					<TD class="table_cell" width="139"><img src="images/icon_point2.gif" width="8" height="11" border="0">섹션상품 화면 선택</TD>
			...
			<tr>
				<td align=center width="764"><img id="preview_img" src="images/sample/section<?=$design?><?=$img_gbn?>.gif" border=0 width=200 class="imgline"></td>
			</tr>
...
<?
		for($i=0;$i<count($templet_list);$i++) {
			...
			echo "<img src=\"images/sample/section".$templet_list[$i].$img_gbn.".gif\" width=\"150\" height=\"160\" border=\"0\" class=\"imgline1\" onMouseOver='changeMouseOver(this);' onMouseOut=\"changeMouseOut(this,'dotted #FFFFFF');\" style='cursor:hand;' onclick='ChangeDesign(".$i.");'>";
			...
			<tr>
				...
				<TR>
					...
					<tr>
						...
						<td width="100%"><span class="font_dotline">섹션상품 템플릿/관련 파일</span></td>
					</tr>
					<tr>
						...
						<td width="100%" class="space_top">
							...
							- <span class="font_orange">템플릿 파일 : /templet/prsection/prsection001.php</span><br />
							- <span class="font_orange">관련 파일 : /front/productsection_text.php</span><br />
							- <span class="font_orange">신상품 : /front/productnew.php</span><br />
							- <span class="font_orange">인기상품 : /front/productbest.php</span><br />
							- <span class="font_orange">추천상품 : /front/producthot.php</span><br />
							- <span class="font_orange">특별상품 : /front/productspecial.php</span>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td width="20" align="right" valign="top"><img src="images/icon_8.gif" width="13" height="18" border="0"></td>
						<td width="100%"><span class="font_dotline">섹션상품 등록</span></td>
					</tr>
					<tr>
						<td width="20" align="right">&nbsp;</td>
						<td width="100%" class="space_top" style="letter-spacing:-0.5pt;">- <a href="javascript:parent.topframe.GoMenu(1,'product_mainlist.php');"><span class="font_blue">상품관리 > 카테고리/상품관리 > 메인상품 진열관리</span></a> 에서 등록한 상품을 자체 화면으로 제공해줍니다.</td>
					</tr>
					<tr>
						<td height="20" colspan="2"></td>
					</tr>
					...
					<tr>
						<td width="20" align="right">&nbsp;</td>
						<td width="100%" class="space_top" style="letter-spacing:-0.5pt;">- <a href="./design_eachsection.php"><span class="font_blue">디자인관리 > 개별디자인 - 페이지 본문 > 상품섹션 화면 꾸미기</span></a> 에서 개별 디자인을 할 수 있습니다.</td>
					</tr>
					<tr>
						<td width="20" align="right">&nbsp;</td>
					...
					<tr>
						<td width="20" align="right">&nbsp;</td>
						<td width="100%" class="space_top" style="letter-spacing:-0.5pt;">- 본 메뉴에서 원하는 템플릿으로 재 선택하면 개별 디자인은 해제되고 선택한 템플릿으로 적용됩니다.</td>
					</tr>
					<tr>
						<td width="20" align="right">&nbsp;</td>
