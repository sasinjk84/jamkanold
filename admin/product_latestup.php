...
<table cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td height="29" colspan="3">
			<table cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td height="28" class="link" align="left" background="images/con_link_bg.gif"><img src="images/top_link_house.gif" border="0" valign="absmiddle">현재위치 : 상점관리 &gt; 카테고리/상품관리 &gt; <span class="2depth_select">최근등록상품</span></td>
			</tr>
			</table>
		</td>
	</tr>   
    ...
    <tr>
        ...
        <td bgcolor="#ffffff" style="padding:10px">
				...
				<tr>
					...
					<TR>
						<TD><IMG SRC="images/product_latestup_title_r.gif" ALT=""></TD>
						</tr><tr>
				...
				<tr>
					...
					<TR>
						...
						<TD width="100%" class="notice_blue">최근 등록된 상품리스트입니다.</TD>
				...
				<?
							...
							$sql.= "FROM tblproduct ORDER BY regdate DESC, productcode ";
