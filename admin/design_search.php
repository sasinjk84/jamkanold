...
if($type=="update" && strlen($design)==3) {
	...
	$onload="<script>alert(\"상품검색 결과화면 템플릿 설정이 완료되었습니다.\");</script>";
}
        ...
        <td bgcolor="#ffffff" style="padding:10px">
			...
			<tr>
				...
				<TR>
					...
					<TD width="100%" class="notice_blue">상품검색 결과화면 디자인을 선택하여 사용하실 수 있습니다.</TD>
			...
			<tr>
				...
				<TR>
					...
					<tr>
						...
						<td width="100%"><span class="font_dotline">상품검색 결과화면 템플릿/관련 파일</span></td>
					</tr>
					<tr>
						...
						<td width="100%" class="space_top">
							...
							- <span class="font_orange">템플릿 파일 : /templet/search/search001.php</span><br />
							- <span class="font_orange">관련 파일 : /front/productsearch.php</span>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td width="20" align="right">&nbsp;</td>
						<td width="100%" class="space_top" style="letter-spacing:-0.5pt;">- <a href="javascript:parent.topframe.GoMenu(2,'design_eachsearch.php');"><span class="font_blue">디자인관리 > 개별디자인 - 페이지 본문 > 상품검색 결과화면 꾸미기</span></a> 에서 개별 디자인을 할 수 있습니다.</td>
					</tr>
					<tr>
						<td width="20" align="right">&nbsp;</td>
