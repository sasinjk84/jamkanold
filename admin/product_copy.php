...
<table cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td height="29" colspan="3">
			<table cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td height="28" class="link" align="left" background="images/con_link_bg.gif"><img src="images/top_link_house.gif" border="0" valign="absmiddle">현재위치 : 상품관리 &gt;카테고리/상품관리 &gt; <span class="2depth_select">상품 이동/복사/삭제</span></td>
			</tr>
			</table>
		</td>
	</tr>
    ...
    <tr>
        ...
        <td bgcolor="#ffffff" style="padding:10px">
			...
			<tr>
				...
				<TR>
					<TD><IMG SRC="images/product_copy_title.gif" ALT=""></TD>
					</tr><tr>
			...
			<tr>
				...
				<?
					if( is_dir('../service/cosmos') ) {
				?>
				<TR>
					<TD background="images/distribute_04.gif"></TD>
					<TD class="notice_blue"><IMG SRC="images/distribute_img.gif" ></TD>
					<TD width="100%" class="notice_blue"><font size="4" color="#FF0000" style="line-height:40px;"><strong>[주의] 해외구매대행 수집 솔루션(코스모스)을 사용한 상품은 이동/복사 시 오류가 발생합니다.</strong></font></TD>
					<TD background="images/distribute_07.gif"></TD>
				</TR>
				<?
					}
