        ...
        <td bgcolor="#ffffff" style="padding:10px">
			...
			<tr>
				...
				<TR>
					<TD background="images/distribute_04.gif"></TD>
					<TD class="notice_blue"><IMG SRC="images/distribute_img.gif" ></TD>
					<TD width="100%" class="notice_blue">특별 상품과 우측 메뉴들의 표시개수 설정을 합니다.</TD>
					<TD background="images/distribute_07.gif"></TD>
				</TR>
				<TR>
					<TD><IMG SRC="images/distribute_08.gif"></TD>
						...
						<td width="560" class="td_con1">
							<table cellpadding="0" cellspacing="0">
								<tr>
									...
									<td style="padding-left:10px;"><p align="left">&nbsp;<input type=radio id="idx_main_special_type1" name=main_special_type value="N" <? if($main_special_type == "N") echo "checked ";?>><label style='cursor:hand;' onmouseover="style.textDecoration='underline'" onmouseout="style.textDecoration='none'" for=idx_main_special_type1>고정된 상품리스트</label></td>
								</tr>
							</table>
							<div style="margin-top:10px;">* <span class="font_blue"><a href="javascript:parent.topframe.GoMenu(2,'design_eachmain.php');">디자인관리 > 개별디자인 - 메인 및 상하단 > 메인본문 꾸미기</a></span> 에서 개별 디자인이 가능합니다.<br>* 공지사항과 컨텐츠, 설문 내용이 없으면 사용자화면에서 자동으로 출력되지 않습니다.</div>
						</td>
					</tr>
					</table>
					</TD>
