...
$colspan=5;
$qry = "WHERE userid='".$_GET['memberID']."' ";
...
<div class="titleStyle"><?=$_GET['memberName']?>(<font color="#fe8e4b"><?=$_GET['memberID']?></font>)회원님의 게시물</div>
...
<table cellpadding="0" cellspacing="0" width="100%">
	...
	mysql_free_result($result);
	if($j==0) {
		echo "<tr><td colspan=\"".$colspan."\" height=\"25\" align=\"center\">등록된 게시물이 없습니다.</td></tr>\n";
		echo "<tr><td height=\"1\" colspan=\"".$colspan."\" background=\"".$Dir."images/common/product/".$_cdata->detail_type."/pdetail_skin_line4.gif\"></td></tr>\n";
	}
?>
			</table>
