...
if($type=="update" && strlen($body)>0) {
	...
	$onload="<script>alert(\"RSS 화면 디자인 수정이 완료되었습니다.\");</script>";
} else if($type=="delete") {
	$sql = "DELETE FROM tbldesignnewpage WHERE type='rssinfo' ";
	mysql_query($sql,get_db_conn());
	$onload="<script>alert(\"RSS 화면 디자인 삭제가 완료되었습니다.\");</script>";
} else if($type=="clear") {
	$body="";
...
<table cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td height="29" colspan="3">
			<table cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td height="28" class="link" align="left" background="images/con_link_bg.gif"><img src="images/top_link_house.gif" border="0" valign="absmiddle">현재위치 : 디자인관리 &gt; 개별디자인-페이지 본문 &gt; <span class="2depth_select">RSS 화면 꾸미기</span></td>
			</tr>
			</table>
		</td>
	</tr>
        ...
        <td bgcolor="#ffffff" style="padding:10px">
			...
			<tr>
				...
				<TR>
					...
					<TD width="100%" class="notice_blue">RSS 화면 디자인을 자유롭게 디자인 하실 수 있습니다.</TD>
			...
			<tr>
				...
				<TR>
					...
					<tr>
						...
						<td ><p class="LIPoint"><B><span class="font_orange">RSS 화면 매크로명령어</span></B>(해당 매크로명령어는 다른 페이지 디자인 작업시 사용이 불가능함)</p></td>
					</tr>
					<tr>
