...
if($_POST['act'] =='updateShopping'){		
	if($fp=@fopen($filename, "w")){
		$naverConf['shopping'] = ($_POST['useNaverEp'] == '1')?'active':'';		
		$naverConf['syncPname'] = trim($_POST['syncPname']);
		fputs($fp, serialize($naverConf));
		fclose($fp);
...
<table cellpadding="0" cellspacing="0" width="690">
    <tr>
        <td><IMG src="http://getmall.co.kr/img/marketing/marketing_naver_timg01.jpg" WIDTH=690 HEIGHT=236 ALT=""></td>
    </tr>
    <tr>
        <td height="19"></td>
    </tr>
        ...
        <td>
			<TABLE WIDTH="100%" BORDER=0 CELLPADDING=0 CELLSPACING=0>
				<TR>
					...
					<TD><IMG src="http://getmall.co.kr/img/marketing/marketing_naver_btn01.gif" WIDTH=186 HEIGHT=77 ALT="" border="0" class="naver" style="cursor:hand"></TD>
				</TR>
			</TABLE>
        </td>
    </tr>
    ...
    <tr>
        <td>
			<TABLE BORDER=0 CELLPADDING=0 CELLSPACING=0 class="tab_list">
				...
				<?
					for($i=1;$i<4;$i++){ ?>					
					<TD><a href="http://getmall.co.kr/front/marketing/marketing_naver.php?step=<?=$i?>&adminUrl=<?=$shopurl?>">
						<IMG src="http://getmall.co.kr/img/marketing/marketing_naver_tap0<?=$i?>.gif" ALT="" border="0"></a></TD>
					<? } ?>					
					<TD id="shopSettingBtn"><a href="/admin/marketing_naver.php?step=4&ext=1" ><IMG src="http://getmall.co.kr/img/marketing/marketing_naver_tap04r.gif" ALT="" border="0"></a></TD>
				</TR>
			</TABLE>
        </td>
    </tr>
...
<table cellpadding="0" cellspacing="0" width="690">
    <tr>
        <td><img src="http://getmall.co.kr/img/marketing/marketing_naver_04_stitle01.gif" width="147" height="50" border="0"></td>
    </tr>
    <tr>
        <td>
            <form name="setNaverEp" method="post" action="<?=$_SERVER['PHP_SELF']?>" style="margin:0px; padding:0px;">
			<input type="hidden" name="act" value="updateShopping" />
			<input type="hidden" name="step" value="<?=$_REQUEST['step']?>" />
			<table cellpadding="2" cellspacing="0" width="100%">
                <tr>
                    <td height="40" colspan="2" bgcolor="#F3F5F0" style="border-top-width:1px; border-bottom-width:1px; border-top-color:rgb(204,205,201); border-bottom-color:rgb(204,205,201); border-top-style:solid; border-bottom-style:solid;" align="center"><img src="http://getmall.co.kr/img/marketing/marketing_naver_04_t01.gif" width="204" height="22" border="0"></td>
                </tr>
				 <tr>
                    ...
                    <td style="padding-left:10px; border-bottom-width:1px; border-bottom-color:rgb(223,225,222); border-bottom-style:solid;">
						<input type="radio" name="useNaverEp" value="1" id="naverEpUse" <? if(!empty($naverConf['shopping'])) echo 'checked'; ?>/>
						<label for="naverEpUse">연동 사용함</label>
						<input type="radio" name="useNaverEp" value="0" id="naverEpNUse" <? if(empty($naverConf['shopping'])) echo 'checked'; ?> />
						<label for="naverEpNUse">연동 사용하지 않음</label>
						<input type="submit" value="적용" />
					</td>
                </tr>
                <tr>
                    <td width="140" height="30" bgcolor="#FBFBF9" style="border-right-width:1px; border-bottom-width:1px; border-right-color:rgb(223,225,222); border-bottom-color:rgb(223,225,222); border-right-style:solid; border-bottom-style:solid;" align="center"><img src="http://getmall.co.kr/img/marketing/marketing_naver_04_t02.gif" width="59" height="18" border="0"></td>
                    <td style="padding-left:10px; border-bottom-width:1px; border-bottom-color:rgb(223,225,222); border-bottom-style:solid;"> <?=$shopurl?>shopping/naver.php <? if(!empty($naverConf['shopping'])){ ?>
				<a href="/shopping/naver.php" target="_blank" style="margin-left:10px;">[미리보기]</a>
				<? } ?></td>
                </tr>
                <tr>
                    <td width="140" height="30" bgcolor="#FBFBF9" style="border-right-width:1px; border-bottom-width:1px; border-right-color:rgb(223,225,222); border-bottom-color:rgb(223,225,222); border-right-style:solid; border-bottom-style:solid;" align="center"><img src="http://getmall.co.kr/img/marketing/marketing_naver_04_t03.gif" width="59" height="19" border="0"></td>
                    <td style="padding-left:10px; border-bottom-width:1px; border-bottom-color:rgb(223,225,222); border-bottom-style:solid;"><?=$shopurl?>shopping/naver_sub.php <? if(!empty($naverConf['shopping'])){ ?>
				<a href="/shopping/naver_sub.php?isdemo=1" target="_blank" style="margin-left:10px;">[미리보기]</a>
				<? } ?></td>
                </tr>
				<tr>
                    ...
                    <td style="padding:4px 10px; border-bottom-width:1px; border-bottom-color:rgb(223,225,222); border-bottom-style:solid;">
						<input type="text" name="syncPname" style="width:300px;" class="input" value="<?=$naverConf['syncPname']?>" ><br />
						<ul style="list-style:none; margin-top:10px;">
							<li style="width:100%; font-size:11px;">
								- 네이버 연동시 검색 최적화 등을 위해 전달되는 상품명을 확장합니다.<br />
    ...
    <tr>
        <td class="m_table_td1">
			위의 전체/요약상품 URL 정보를 네이버 쇼핑광고센터(<a href="https://adcenter.shopping.naver.com" target="_blank"><b><font color="#000000">https://adcenter.shopping.naver.com</font></b></a>)에 등록하시면 됩니다.<br />
			자세한 등록 방법은 아래의 <b>&ldquo;쇼핑몰 상품 DB URL 등록방법(네이버)&rdquo;</b>을 참고하세요.</td>
    </tr>
    <tr>
        <td align="right"><a href="https://adcenter.shopping.naver.com" target="_blank"><img src="http://getmall.co.kr/img/marketing/marketing_naver_04_btn01.gif" border=0></a></td>
    </tr>
    <tr>
        <td height="40"><IMG border=0 src="http://getmall.co.kr/img/cmn/con_line02.gif" width="100%" height=1></td>
    </tr>
    <tr>
        <td><img src="http://getmall.co.kr/img/marketing/marketing_naver_04_stitle02.gif" width="334" height="50" border="0"></td>
    </tr>
    <tr>
        <td><img src="http://getmall.co.kr/img/marketing/marketing_naver_04_img01.jpg" width="690" height="458" border="0"></td>
    </tr>
    <tr>
        <td><img src="http://getmall.co.kr/img/marketing/marketing_naver_04_img02.jpg" width="690" height="520" border="0"></td>
    </tr>
    <tr>
        <td height="20"></td>
    </tr>
    <tr>
        <td align="center"><a href="https://adcenter.shopping.naver.com" target="_blank"><img src="http://getmall.co.kr/img/marketing/marketing_naver_04_btn01.gif" border=0></a></td>
    </tr>
    <tr>
        <td height="60"></td>
    </tr>
