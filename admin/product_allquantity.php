...
function Search() {
	...
	document.form1.action="product_allquantity.list.php";
...
<table cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td height="29" colspan="3">
			<table cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td height="28" class="link" align="left" background="images/con_link_bg.gif"><img src="images/top_link_house.gif" border="0" valign="absmiddle">현재위치 : 상품관리 &gt; 상품 일괄관리 &gt; <span class="2depth_select">재고상품 일괄관리</span></td>
			</tr>
			</table>
		</td>
	</tr>
    ...
    <tr>
        ...
        <td bgcolor="#ffffff" style="padding:10px">
			...
			<tr>
				...
				<TR>
					<TD><IMG SRC="images/product_allquantity_title.gif" ALT=""></TD>
					</tr><tr>
			...
			<tr>
				...
				<TR>
					...
					<TD width="100%" class="notice_blue">모든 상품의 재고를 확인할 수 있습니다.</TD>
			...
			<tr>
				...
				<tr>
					...
					<tr>
						...
						<TR>
							<TD class="table_cell" width="153">
								<img src="images/icon_point2.gif" width="8" height="11" border="0"><b>검색조건 선택</b>
							</TD>
							<TD class="td_con1">
			...
			<tr>
				...
				<tr>
					...
					<tr>
						...
						<table cellpadding="0" cellspacing="0" width="246" height="100%">
						<tr>
			...
			<tr>
				...
				<TR>
					...
					<tr>
						<td align="right">&nbsp;</td>
						<td class="space_top">- 전체상품 : 선택한 카테고리내 모든 상품이 출력됩니다.</td>
					</tr>
					<tr>
						<td align="right">&nbsp;</td>
						<td class="space_top">- 재고상품 : 선택한 카테고리내 품절된 <span class="font_blue">상품을 제외한</span> 모든 상품<이 출력됩니다.</td>
					</tr>
					<tr>
						<td align="right">&nbsp;</td>
						<td class="space_top">- 품절상품 : 선택한 카테고리내 <span class="font_orange">품절된</span> 모든 상품이 출력됩니다.</td>
					</tr>
					<tr>
					...
					<tr>
						<td align="right" valign="top"><img src="images/icon_8.gif" width="13" height="18" border="0"></td>
						<td><span class="font_dotline">재고상품 일괄관리 주의사항</span></td>
					</tr>
					<tr>
						<td align="right">&nbsp;</td>
						<td class="space_top">- 수정모드는 새창 버튼 클릭시 출력됩니다.</td>
					</tr>
					<tr>
						<td align="right">&nbsp;</td>
						<td class="space_top">- 수정된 내용은 복원 되지 않으므로 신중히 처리하시기 바랍니다.</td>
					</tr>
					<tr>
						<td colspan="2" height="20"></td>
					</tr>
					<tr>
						<td align="right" valign="top"><img src="images/icon_8.gif" width="13" height="18" border="0"></td>
						<td><span class="font_dotline">재고상품 일괄관리 방법</span></td>
					</tr>
					<tr>
						<td align="right">&nbsp;</td>
						<td class="space_top">① 변경을 원하는 카테고리를 선택합니다.</td>
					</tr>
					<tr>
						<td align="right">&nbsp;</td>
					...
					<tr>
						<td align="right">&nbsp;</td>
						<td class="space_top">③ 수정을 원하는 상품에 새창 버튼을 클릭합니다.</td>
					</tr>
					<tr>
						<td align="right">&nbsp;</td>
						<td class="space_top">④ 새창에서 수정내용을 입력 후 [상품정보 수정하기] 버튼을 클릭합니다.</td>
					</tr>
					</table>
					</TD>
