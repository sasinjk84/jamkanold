...
if ( $type=="store" OR $type=="restore" ) {
	...
	$MSG = adminDesingBackup ( $type, 'design_myreserve', 'U', $subject, '', '', '', 'tblshopinfo', 'design_myreserve' );
...
if($type=="update" && strlen($body)>0) {
	...
	$onload="<script>alert(\"마이페이지 적립금 화면 디자인 수정이 완료되었습니다.\");</script>";
} else if($type=="delete") {
	...
	mysql_query($sql,get_db_conn());
	DeleteCache("tblshopinfo.cache");
	$onload="<script>alert(\"마이페이지 적립금 화면 디자인 삭제가 완료되었습니다.\");</script>";
} else if($type=="clear") {
	$intitle="";
	$body="";
...
//매크로 보기(팝업)
function macroview(){
	window.open("http://www.getmall.co.kr/macro/pages/reserve_macro.html","reserve_macro","height=800,width=680,scrollbars=no");
}
...
<table cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td height="29" colspan="3">
			<table cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td height="28" class="link" align="left" background="images/con_link_bg.gif"><img src="images/top_link_house.gif" border="0" valign="absmiddle">현재위치 : 디자인관리 &gt; 개별디자인-페이지 본문 &gt; <span class="2depth_select">적립금 화면 꾸미기</span></td>
			</tr>
			</table>
		</td>
	</tr>
        ...
        <td bgcolor="#ffffff" style="padding:10px">
			...
			<tr>
				<td>
					<TABLE WIDTH="100%" BORDER=0 CELLPADDING=0 CELLSPACING=0>
						<TR>
							<TD><IMG SRC="images/design_eachmyres_title.gif" ALT=""></TD>
						</tr>
						<tr>
			...
			<tr>
				...
				<TR>
					...
					<TD width="100%" class="notice_blue">마이페이지 적립금 화면 디자인을 자유롭게 디자인 하실 수 있습니다.</TD>
			...
			<tr>
				...
				<TABLE WIDTH="100%" BORDER=0 CELLPADDING=0 CELLSPACING=0>
				<TR>
					<TD><IMG SRC="images/design_eachmyres_stitle1.gif"  ALT=""></TD>
					<TD width="100%" background="images/shop_basicinfo_stitle_bg.gif">
						&nbsp;&nbsp;<a href="javascript:macroview();"><img src="images/btn_macroview.gif" border="0" align="absmiddle" alt="" /></a>&nbsp;&nbsp;<a href="http://www.getmall.co.kr/macro/data/reserve_design.zip"><img src="images/btn_defaultcode.gif" border="0" align="absmiddle" alt="" />
					</TD>
			...
			<tr>
				...
				<TR>
					...
					<tr>
						...
						<tr><td colspan=2 height=1 bgcolor=#dddddd></td></tr>
						<tr>
							<td class=table_cell width=180 align=right style="padding-right:15" nowrap>[IFRESERVECASH]<br>[RESERVECASH]<br>[IFENDRESERVECASH]</td>
							<td class=td_con1 width=100% style="padding-left:5;">
							적립금 현금전환 기능이 있을경우
							<pre style="line-height:15px">
<FONT class=font_blue>   <B>[IFRESERVECASH]</B>
      적립된 적립금은 <B>[RESERVECASH]</B>원 단위로 현금으로 전환하실 수 있습니다.&lt;a href=<B>[RESERVECASHLINK]</B>>현금전환신청(텍스트 또는 이미지)&lt;/a>
   <B>[IFENDRESERVECASH]</B></font></pre>
							</td>
						</tr>
						<tr><td colspan=2 height=1 bgcolor=#dddddd></td></tr>
						<tr>
...
<FONT class=font_blue>   [IFRESERVE]
   ...
   [IFENDRESERVE]</font></pre>
					...
					<tr>
						<td width="20" align="right" valign="top"><img src="images/icon_8.gif" width="13" height="18" border="0"></td>
						<td ><p class="LIPoint">나모,드림위버등의 에디터로 작성시 이미지경로등 작업내용이 틀려질 수 있으니 주의하세요!</p>
						</td>
					</tr>
					</table>
					</TD>
