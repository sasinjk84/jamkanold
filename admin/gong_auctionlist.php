...
if($mode=="delete" && strlen($auction_seq)>0 && strlen($auction_date)>0) {
	...
	$sql.= "WHERE auction_seq='".$auction_seq."' AND start_date='".$auction_date."' ";
	mysql_query($sql,get_db_conn());
	$onload="<script>alert(\"해당 경매를 삭제하였습니다.\");</script>";
	...
	$sql.= "WHERE auction_seq='".$auction_seq."' AND start_date='".$auction_date."' ";
	mysql_query($sql,get_db_conn());
	$onload="<script>alert(\"최종낙찰자 삭제가 완료되었습니다.\");<script>";
}
...
<table cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td height="29" colspan="3">
			<table cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td height="28" class="link" align="left" background="images/con_link_bg.gif"><img src="images/top_link_house.gif" border="0" valign="absmiddle">현재위치 : 공구/경매 &gt; 쇼핑몰 경매 관리 &gt; <span class="2depth_select">등록 경매 관리</span></td>
			</tr>
			</table>
		</td>
	</tr>   
...
<TD width="100%" background="images/title_bg.gif" height="21"></TD>
			...
			<tr>
				...
				<TR>
					...
					<TD width="100%" class="notice_blue">등록된 경매를 관리할 수 있습니다.</TD>
			...
			<tr>
				...
				<TR align=center>
					<TD class="table_cell">경매 마감일</TD>
					<TD class="table_cell1">경매 상품명</TD>
					<TD class="table_cell1">최종입찰자</TD>
					<TD class="table_cell1">최종입찰가</TD>
					<TD class="table_cell1">입찰수</TD>
...
<?
				...
				while($row=mysql_fetch_object($result)) {
					...
					echo "	<TD align=center class=\"td_con1\"><b><span class=\"font_orange\">".number_format($row->last_price)."원</span></b></TD>\n";
...
?>
			...
			<tr>
				...
				<TR>
					...
					<tr>
						<td align="right">&nbsp;</td>
						<td class="space_top" style="letter-spacing:-0.5pt;">- 최종입찰자와 최종입찰가만 출력되며, 최종 입찰자 클릭시 해당 회원 정보가 출력됩니다.</td>
					</tr>
					<tr>
						<td align="right">&nbsp;</td>
						<td class="space_top" style="letter-spacing:-0.5pt;">- 경매마감시 <b>최종입찰자</b>가 경매 상품을 구매할 수 있게 별도 처리하셔야 합니다.</td>
					</tr>
					<tr>
						<td align="right">&nbsp;</td>
						<td class="space_top" style="letter-spacing:-0.5pt;">- 등록된 경매 상품 중 입찰자가 없는 상품은 상품명 클릭후 수정이 가능합니다.</td>
					</tr>
					<tr>
						<td align="right">&nbsp;</td>
						<td class="space_top" style="letter-spacing:-0.5pt;">- 경매 목록 누적시 마감된 경매는 삭제 처리해 주시면 됩니다.</td>
					</tr>
					</table>
					</TD>
