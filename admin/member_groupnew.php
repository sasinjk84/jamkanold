...
<tr>
			...
			<tr>
				...
				<TR>
					...
					<TD width="100%" class="notice_blue">회원등급 신규등록/수정/삭제를 하실 수 있으며 등급별 권한설정이 가능합니다.</TD>
...
<? /*
			...
			<tr>
				...
				<span>
					<ul style="list-style:none; margin:6px 0px; padding-left:20px;">
						...
						<li class="notice_blue"><img src="images/groupaoutoUp.jpg" alt="회원등급 자동승급 수동실행" style="cursor:pointer;" onclick="groupaoutoPop();"></li>						
						<? } ?>
						<li class="notice_blue">1) <span class="font_orange" style="font-size:11px;">자동 승급을 위해서는 선택하신 승급 실행 방식에 따라 서버단의 스케줄링 프로그램을 이용하거나 또는, 관리자가 직접 페이지를 호출 하는 방식을 통해 <b>/admin/groupauto.php</b> 파일을 지정일에 호출해 주셔야 합니다.</span></li>
						<li class="notice_blue">2) 1개의 항목이라도 공백으로 두시면 사용이 해제 됩니다.</li>
						<li class="notice_blue">3) 합산시작일과 합산반영일이 30을 넘거나 숫자이외의 문자로 입력되면 1 로 저장됩니다.</li>
						<li class="notice_blue">4) 합산기간은 1~12 의 범위를 벗어날 경우 12 로 입력 됩니다.</li>
						<li class="notice_blue">5) 누적금액 비교는 등급설정상의 누적 급액의 값보다 큰경우 해당 등급으로 승급됩니다.</li>
					</ul>
				</span>
				</td>
			</tr>
			...
			<tr>
				...
				<TR>
					<TD background="images/distribute_04.gif"></TD>
					<TD class="notice_blue"><IMG SRC="images/distribute_img.gif" ></TD>
					<TD width="100%" class="notice_blue">신규회원가입시 선택된 등급으로 자동 가입됩니다.</TD>
					<TD background="images/distribute_07.gif"></TD>
				</TR>
				<TR>
					<TD><IMG SRC="images/distribute_08.gif"></TD>
...
?>
			...
			<tr>
				...
				<TR align=center>
					...
					<TD class="table_cell1" rowspan="3">등급명</TD>
					<TD class="table_cell1" width="20%" rowspan="3">인증조건</TD>
					<TD class="table_cell1" colspan="2">혜택</TD>
					<TD class="table_cell1" colspan="4">등업조건</TD>
					<!-- <TD class="table_cell1">추가적립&할인</TD>
					<TD class="table_cell1">혜택및제한</TD>
					<TD class="table_cell1">배송비</TD> -->
					<TD class="table_cell1" rowspan="3">회원수</TD>
					<!-- <TD class="table_cell1" rowspan="3">수정</TD>
					<TD class="table_cell1" rowspan="3">삭제</TD> -->
				</TR>
				<TR>
				...
				<tr>
					...
					<TD class="table_cell1">제한</TD>
					<TD class="table_cell1">보증금</TD>
					<TD class="table_cell1">최근1개월</TD>
					<TD class="table_cell1">최근1년</TD>
					<TD class="table_cell1">위탁물품</TD>
				</tr>
				<TR>
...
?>
					...
					<tr>
						...
						<TD align=center class="td_con1"><?=number_format($row->group_addmoney).($group_view=="P"?"%":"원")?></TD>
						...
						<!-- <TD align=center class="td_con1" style="text-align:left; padding-left:5px;">
							...
							if($group_type=="R") echo ((intval($row->group_usemoney) >0)?number_format($row->group_usemoney).'원 이상 구매시':'').number_format($row->group_addmoney).($group_view=="P"?"배":"원");
							else echo 'X'; ?></span><br>
				...
				mysql_free_result($result);
				if ($i==0) {
					echo "<tr><td class=\"td_con2\" colspan=\"13\" align=\"center\">등록된 회원등급이 없습니다.</td></tr>";
				}
?>
				<TR>
					<TD background="images/table_top_line.gif" colspan="13" height=1></TD>
...
?>
			...
			<tr>
				...
				<TR>
					<TD class="table_cell"><img src="images/icon_point2.gif" width="8" height="11" border="0">추천적립금</TD>
					<TD class="td_con1">
						<input type="radio" name="group_recommand" value="Y" id="group_recommand1" <?if($group_recommand=="Y")echo"checked";?> ><label style='cursor:hand; TEXT-DECORATION: none;' onmouseover="style.textDecoration='underline'" onmouseout="style.textDecoration='none'" for=group_recommand1>타회원추천후 구매시 적립금 지금</span></label> &nbsp;&nbsp;
						<input type="radio" name="group_recommand" value="N" id="group_recommand2"  <?if($group_recommand=="N")echo"checked";?>><label style='cursor:hand; TEXT-DECORATION: none;' onmouseover="style.textDecoration='underline'" onmouseout="style.textDecoration='none'" for=group_recommand2>추천 적립금 지금 불가</span></label>
					</TD>
				</TR>
				<?
					/*
			...
			<? } ?>
			<tr><td align=center style="color:red;">추천인회원등급은 상품카테고리와 프로그램처리되어 있습니다. 등급 생성 및 수정 관련한 내용은 개발업체에 문의주세요.</td></tr>
			...
			<tr>
				...
				<TR>
					...
					<tr>
						...
						<td ><p><span class="font_dotline">회원등급 기본정보 관리</span></td>
					</tr>
					<tr>
