...
<table cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td height="29" colspan="3">
			<table cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td height="28" class="link" align="left" background="images/con_link_bg.gif"><img src="images/top_link_house.gif" border="0" valign="absmiddle">현재위치 : 통계분석 &gt; 트래픽 분석 &gt; <span class="2depth_select">일자별 주문시도건수</span></td>
			</tr>
			</table>
		</td>
	</tr>
...
<?}?>
			<tr>
				...
				<TR>
					<TD><IMG SRC="images/counter_dayorder_title.gif"  ALT=""></TD>
					</tr>
<tr>
...
<?
				if($searchdate>=date("Ym",mktime(0,0,0,date("m")-1,date("d"),date("Y")))) {
					...
					$sql ="SELECT MID(date,7,2) as day, cnt FROM tblcounterordermonth ";
...
?>
				...
				<tr>
					...
					<TR>
						...
						<TD class="table_cell" align=center><FONT color=#3d3d3d>주문시도건수</FONT></TD>
			...
			<tr>
				...
				<TR>
					...
					<tr>
						...
						<td><FONT color=#3d3d3d>일자별 쇼핑몰 주문시도건수를 보여 드리고 있습니다.</FONT></td>
					</tr>
					<tr><td colspan=2 height=5></td></tr>
					<tr>
						<td width="20" align="right" valign="top"><img src="images/icon_8.gif" width="13" height="18" border="0"></td>
						<td>
							<FONT color=#3d3d3d>한달기준으로 방문자가 쇼핑몰에 방문하여 얼마나 많은 주문을 했는지 알 수 있습니다.<br>
							일자별 주문시도건수, 방문자수, 페이지뷰를 분석하여 각 요인이 쇼핑몰에 어떻게 반영되고 있는 지 분석할 수 있습니다.</FONT>
						</td>
					</tr>
					<tr><td colspan=2 height=5></td></tr>
					<tr>
						<td width="20" align="right" valign="top"><img src="images/icon_8.gif" width="13" height="18" border="0"></td>
						<td>
							<FONT color=#3d3d3d>한달기준으로 최고 주문시도건수를 나타낸 일자의 방문자수와 페이지뷰를 분석하여,<br>
							주문시도건수와의 상관관계를 알 수 있습니다.<br>
							예를 들면, 1월중 11일에 최고 주문시도건수인 150건이 발생했는 데, 이 날의 순방문자 순위는 10위이고, 페이지뷰는 2위인 경우,<br>
							이날 신규상품이나 인기상품의 등록등 컨텐츠 요소에 의한 주문시도건수의 순증가를 나타냈다고 볼 수 있습니다.<br>
							외부요인인 순방문자가 증가하여 주문이 증가한 것이 아니고, 페이지뷰, 즉 내부요인에 의해서 주문이 증가한 경우입니다.<br>
							그리고, 이 날의 컨텐츠의 갱신은 아주 성공적이었다고 평가할 수 있습니다</FONT>
						</td>
					</tr>
					</table>
					</TD>
