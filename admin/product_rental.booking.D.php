...
<tr>
	<td><img src="images/product_rental_stitle3.gif" alt="일일 예약/렌탈 현황" /></td>
</tr>
<tr>
	<td>
		<table border="0" cellpadding="0" cellspacing="0" width="100%" height="24" class="tb_orderbytype" style="margin-bottom:2px;">
			<tr>
				...
				<td style="padding-right:10px;text-align:right;font-size:0px; width:300px;"><img src="images/counter_tab_day_on.gif" border="0" alt="일일" style="margin-right:3px;"/> &nbsp; <a href="javascript:changeListType('W')" style="margin-right:3px;"><img src="images/counter_tab_week_off.gif" border="0" alt="주간" /></a> &nbsp; <a href="javascript:changeListType('M')"><img width="74" height="20" src="images/counter_tab_month_off.gif" border="0" alt="월간" /></a></td>
			</tr>
		</table>
		...
		<?	}else{
			...
			<tr>
				...
				?>
				<td align="center" class="<?=$class?> scheduledItem" layerid="<?=$divid?>" onclick="changeStatus('<?=$schduled['ordercode']?>', '<?=$schduled['basketidx']?>')"><?=rentProduct::_bookingStatus($schduled['status'])?>[<?=$schduled['sender_name']?>]<?=infoareaHtml($schduled,$divid)?></td>
			</tr>
				<?		}// end sc foreach
					}// end opt foreach
				}// end  product foreach
