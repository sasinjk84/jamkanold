...
<html STYLE="width: 238px; height: 187px"><head><title>Color</title>
...
function View(color) {                  // preview color
  if(color == "" || color.length != 6) color = "FFFFFF";
...
<table border="0" cellspacing="0" cellpadding="4" width="100%">
 <tr>
  <td bgcolor="buttonface" valign="center"><div style="background-color:#000000;padding:1px;height:21px;width:50px;"><div id="ColorPreview" style="height:100%;width:100%"></div></div></td>
