...
<tr>
	<TD align="center"><A HREF="javascript:document.form1.submit();"><IMG SRC="<?=$Dir.AdultDir?>images/b2b_join_agree.gif" border="0"></a><A HREF="javascript:window.close();"><IMG SRC="<?=$Dir.AdultDir?>images/b2b_join_no.gif" border="0" hspace="5"></a></TD>
</tr>
<TR>
	<TD height="10"></TD>
</TR>
<form name=form1 action="<?=$Dir.AdultDir?>adult_btbjoin.php" method=post>
</form>
</TABLE>
</body>
</html>