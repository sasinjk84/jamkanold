...
if (empty($sitecd)) {
	echo "<html><head><title></title></head><body onload=\"alert('이니시스 상점ID가 없습니다.');history.go(-1);\"></body></html>";exit;
}
if (empty($sitekey)) {
	echo "<html><head><title></title></head><body onload=\"alert('이니시스 상점KEY가 없습니다.');history.go(-1);\"></body></html>";exit;
}
