<?
/*
if(substr(getenv("SCRIPT_NAME"),-18)=="/cache_product.php"){
...
$cache_file_name = escapeshellcmd($Dir.DataDir."cache/product/".$HOST_NAME."_".substr(getenv("REQUEST_URI"),strrpos(getenv("SCRIPT_NAME"),"/")+1));
