												...
												<tr>
													<td align="center">
														...
														<table cellspacing="0" cellpadding="0" border="0" class="leftMenu">
															<!--
															<tr>
																<td><img src="/data/design/img/sub/tit_mini_category.gif" alt="" /></td>
															</tr>
															<tr><td height="10"></td></tr>
															-->
															<?
																if(substr($code,0,3)=="000"){
																	...
																	for($i=0;$i<count($prdataA);$i++) {
																		...
																		if(substr($code,3*$ni,3)=="000"){
																			...
																			echo "<tr>
																				<td class=\"menu\"><a href=\"javascript:GoSection('".$_minidata->vender."','10','".substr($code,0,3*$ni)."')\">".$_MiniLib->codename[$code]."[".(int)$_MiniLib->codecnt[substr($code,0,3*$ni)]."]</a></td>
																			</tr>
																			";
																			$a_line = 1;
																		}
