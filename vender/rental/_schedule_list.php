...
<script type="text/javascript">
	...
	function changeStatus(ordercode, bskidx) {
		window.open( "/admin/product_rental.change.status.php?ord="+ordercode+"&bskidx="+bskidx, "changeStatus" , "width=620, height=500, menubar=no, status=no, scrollbars=no" );
	}
	-->
</script>
...
<table border=0 cellpadding=0 cellspacing=0 width=100% height="100%" style="table-layout:fixed">
	...
	<tr>
		...
		<td valign=top style="padding-top:20px">
			...
			*/		
			?>
			<? include "./rental/booking".$_SESSION['datet'].".php"; ?>
			<!-- 처리할 본문 위치 끝 -->		
		</td>
