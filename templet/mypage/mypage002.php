...
<tr>
	...
	<tr>
		...
		<TR>
			<TD><A HREF="<?=$Dir.FrontDir?>mypage.php"><IMG SRC="<?=$Dir?>images/common/mypersonal_skin2_menu1r.gif" BORDER="0"></A></TD>
	...
	<tr>
		...
		<tr>
			...
			<tr>
				...
				<tr>
					<td><IMG SRC="<?=$Dir?>images/common/mypage/<?=$_data->design_mypage?>/mypage_skin2_tabel01.gif" border="0"></td>
				</tr>
				<tr>
					<td background="<?=$Dir?>images/common/mypage/<?=$_data->design_mypage?>/mypage_skin2_tabel01bg.gif" style="padding-top:10px;">
					...
					<tr>
						...
						<tr>
							<td align="center"><A HREF="<?=$Dir.FrontDir?>mypage_reserve.php"><IMG SRC="<?=$Dir?>images/common/mypage/<?=$_data->design_mypage?>/mypage_skin2_tabel01btn.gif" BORDER="0"></A></td>
						</tr>
						</table>
						</td>
						<td align="center"><img src="<?=$Dir?>images/common/mypage/<?=$_data->design_mypage?>/mypage_skin2_tabel01line.gif" border="0"></td>
						<td valign="top">
						<table cellpadding="0" cellspacing="0" width="100%">
						<tr>
						...
						<tr>
							<td align="center"><A HREF="<?=$Dir.FrontDir?>mypage_coupon.php"><IMG SRC="<?=$Dir?>images/common/mypage/<?=$_data->design_mypage?>/mypage_skin2_tabel01btn.gif" BORDER="0"></A></td>
						</tr>
						</table>
						</td>
						<td align="center"><img src="<?=$Dir?>images/common/mypage/<?=$_data->design_mypage?>/mypage_skin2_tabel01line.gif" border="0"></td>
						...
						<tr>
							<td align="center"  style="padding-top:8px"><A HREF="<?=$Dir.FrontDir?>mypage_auth.php"><IMG SRC="<?=$Dir?>images/common/mypage/<?=$_data->design_mypage?>/mypage_skin2_authbtn.gif" BORDER="0" alt="인증"></A></td>
						</tr>
						</table>
						</td>
					</tr>
				...
				<tr>
					<td background="<?=$Dir?>images/mypage_skin2_tabel01bg.gif"><IMG SRC="<?=$Dir?>images/common/mypage/<?=$_data->design_mypage?>/mypage_skin2_tabel01down.gif" border="0"></td>
				</tr>
				</table>
				</td>
				<td width="50%" align="right" valign="top">
					...
					<tr>
						<td><IMG SRC="<?=$Dir?>images/common/mypage/<?=$_data->design_mypage?>/mypage_skin2_tabel02.gif" border="0"></td>
					</tr>
					<tr>
						<td background="<?=$Dir?>images/common/mypage/<?=$_data->design_mypage?>/mypage_skin2_tabel01bg.gif" style="padding-top:10px;padding-left:15px;">
						<table cellpadding="0" cellspacing="0" width="100%">
						<col width="6"></col>
						<col width="49"></col>
						<col width="5"></col>
						...
						<tr style="letter-spacing:-0.5pt;">
							<td><img src="<?=$Dir?>images/common/mypage/<?=$_data->design_mypage?>/mypage_skin2_tabelpoint.gif" border="0"></td>
					...
					<tr>
						<td><IMG SRC="<?=$Dir?>images/common/mypage/<?=$_data->design_mypage?>/mypage_skin2_tabel02down.gif" border="0"></td>
					</tr>
					</table>
				</td>
			</tr>
...
?>
		...
		<tr>
			<td>
			<table cellpadding="0" cellspacing="8" width="100%" bgcolor="#FFE8CF">
			<tr>
				<td background="<?=$Dir?>images/common/mypage/<?=$_data->design_mypage?>/design_search_skin2_tbg.gif" style="padding:10px;">
...
?>
	...
	<tr>
		...
		<table cellpadding="0" cellspacing="0" width="100%">
		<tr>
			<td><IMG SRC="<?=$Dir?>images/common/mypage/<?=$_data->design_mypage?>/mypage_skin2_text01.gif" border="0"></td>
	...
	<tr>
		<td>
			...
			<tr>
				...
				<td width="100%" align="right"><A HREF="<?=$Dir.FrontDir?>mypage_orderlist.php"><IMG SRC="<?=$Dir?>images/common/mypage/<?=$_data->design_mypage?>/mypage_skin2_btn01.gif" BORDER="0"></A></td>
			</tr>
			</table>
		</td>
	</tr>
...
?>
	...
	<tr>
		...
		<table cellpadding="0" cellspacing="0" width="100%">
		<tr>
			<td><IMG SRC="<?=$Dir?>images/common/mypage/<?=$_data->design_mypage?>/mypage_skin2_text02.gif" border="0"></td>
			<td align="right" style="padding-bottom:3px;"><A HREF="<?=$Dir.FrontDir?>mypage_personal.php"><IMG SRC="<?=$Dir?>images/common/mypage/<?=$_data->design_mypage?>/mypage_skin2_btn01.gif" BORDER="0"></A></td>
		</tr>
		</table>
		</td>
	</tr>
...
?>
	...
	<tr>
		...
		<table cellpadding="0" cellspacing="0" width="100%">
		<tr>
			<td><IMG SRC="<?=$Dir?>images/common/mypage/<?=$_data->design_mypage?>/mypage_skin2_text03.gif" border="0"></td>
			<td align="right" style="padding-bottom:3px;"><A HREF="<?=$Dir.FrontDir?>wishlist.php"><IMG SRC="<?=$Dir?>images/common/mypage/<?=$_data->design_mypage?>/mypage_skin2_btn01.gif" BORDER="0"></A></td>
		</tr>
		</table>
		</td>
	</tr>
