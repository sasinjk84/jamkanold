...
<tr>
	...
	<tr>
		...
		<col width=></col>
		<tr>
			<td align="center"><a href="javascript:CheckForm();"><IMG SRC="<?=$Dir.AdultDir?>images/adultintro_skin3_btn1.gif" ALT="쇼핑몰 이용하기" border="0"></a><a href="javascript:history.go(-1);"><IMG SRC="<?=$Dir.AdultDir?>images/adultintro_skin3_btn2.gif" ALT="19세 미만 나가기" hspace="7" border="0"></a></td>
