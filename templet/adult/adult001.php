...
<body bgcolor="white" text="black" link="blue" vlink="purple" alink="red" leftmargin="0" marginwidth="0" topmargin="0" marginheight="0" background="<?=$Dir.AdultDir?>images/adultintro_skin1_bg.gif" onload="document.form1.name.focus()">
...
<?}?>
<tr>
	<td height="76" background="<?=$Dir.AdultDir?>images/adultintro_skin1_top.gif"></td>
</tr>
<tr>
	<td align=center background="<?=$Dir.AdultDir?>images/adultintro_skin1_linebg.gif">
	<table cellpadding="0" cellspacing="0">
	<col width="1"></col>
	<col width=></col>
	<col width="1"></col>
	<tr>
		<td valign="top" background="<?=$Dir.AdultDir?>images/adultintro_skin1_linebg.gif"><img src="<?=$Dir.AdultDir?>images/adultintro_skin1_linebg.gif" border="0"></td>
		<td valign="top" background="<?=$Dir.AdultDir?>images/adultintro_skin1_linebg.gif">
		<table cellpadding="0" cellspacing="0">
		<col width="1"></col>
		<col width=></col>
		<col width="1"></col>
		<tr>
			<td><IMG SRC="<?=$Dir.AdultDir?>images/adultintro_skin1_img1.gif" border="0"></td>
			<td colspan="2" align="right"><IMG SRC="<?=$Dir.AdultDir?>images/adultintro_skin1_text1.gif" border="0"></td>
		</tr>
		<tr>
			<td><IMG SRC="<?=$Dir.AdultDir?>images/adultintro_skin1_img2.gif" border="0"></td>
			<td align="center">
			<table cellpadding="0" cellspacing="0">
			<tr>
				<td>
				<table cellpadding="0" cellspacing="0">
				<tr>
					<td><IMG SRC="<?=$Dir.AdultDir?>images/adultintro_skin1_text2.gif" border="0"></td>
					<td><input type=text name=name tabindex="1" style="width:100px" class="input"></td>
				</tr>
				<tr>
					<td><IMG SRC="<?=$Dir.AdultDir?>images/adultintro_skin1_text3.gif" border="0"></td>
					<td>
					<table cellpadding="0" cellspacing="0">
					<tr>
				...
				<tr>
					<td colspan="2"><a href="javascript:CheckForm();"><IMG SRC="<?=$Dir.AdultDir?>images/adultintro_skin1_btn1.gif" ALT="쇼핑몰 이용하기" border="0"></a><a href="javascript:history.go(-1);"><IMG SRC="<?=$Dir.AdultDir?>images/adultintro_skin1_btn2.gif" ALT="19세 미만 나가기" hspace="8" border="0"></a></td>
				</tr>
				</table>
				</td>
			</tr>
			...
			<td align="right"><IMG SRC="<?=$Dir.AdultDir?>images/adultintro_skin1_img3.gif" border="0"></td>
		</tr>
		</table>
		</td>
		<td valign="top" background="<?=$Dir.AdultDir?>images/adultintro_skin1_linebg.gif"><img src="<?=$Dir.AdultDir?>images/adultintro_skin1_linebg.gif" border="0"></td>
...
<tr>
	<td background="<?=$Dir.AdultDir?>images/adultintro_skin1_bg.gif" align="center">
	<table cellpadding="0" cellspacing="0">
	<tr>
