			...
			<td style="padding:25px;">
				<table cellpadding="0" cellspacing="0">
					<tr>
						...
						<td style="font-size:28px;line-height:28px;letter-spacing:-0.5pt;"><font color="#FF6600"><b><?=$coupon_cnt?>장</b></font></td>
						<td><img src="<?=$Dir?>images/common/mycoupon/<?=$_data->design_mycoupon?>/mycp_skin3_t_text2.gif" border="0"></td>
					</tr>
				</table>
			</td>
			<td align="right" style="padding-right:25px;"><a href="javascript:addOffCoupon();"><!--쿠폰등록--><img src="/images/common/mycoupon/mycp_insert.gif" border="0" alt="쿠폰등록" /></a></td>
		</tr>
		</table>
		</td>
	</tr>
