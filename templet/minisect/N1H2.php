...
<?
	...
	if(isset($specialprlist[$kk])) {
		...
		echo "	</tr>\n";
		echo "	<tr>\n";
		echo "		<td width=270 height=41 valign=top style=\"word-break:break-all;\" nowrap><A HREF=\"javascript:GoItem('".$specialprlist[$kk]->productcode."')\">".viewproductname($specialprlist[$kk]->productname,$specialprlist[$kk]->etctype,$specialprlist[$kk]->selfcode)."</a></td>\n";
		echo "	</tr>\n";
		echo "	<tr>\n";
		echo "		<td height=4></td>\n";
		echo "	</tr>\n";
