...
<tr>
	...
	<tr>
		...
		<tr>
			...
			<td width="100%" background="<?=$Dir?>images/common/prsection/<?=$prsection_type?>/plist_skin_stibg.gif" style="color:#666666;font-size:11px;"> 총 등록상품 : <b><?=$t_count?>건</b></td>
...
<?
		if($t_count<=0) {
			...
			while($row=mysql_fetch_object($result)) {
				...
				if ($i!=0 && $i%2==0) {
					echo "</tr><tr><td height=\"5\"></td></tr><tr><td height=\"1\" colspan=\"3\" bgcolor=\"#EDEDED\"></td></tr><tr><td height=\"5\"></td></tr>\n";
				}
				echo "<td>\n";
				...
				echo "<col width=\"100%\"></col>\n";
				echo "<TR>\n";
				echo "	<TD width=\"100\" align=\"center\" style=\"padding-top:1px;padding-bottom:1px;\" nowrap>";
				...
				echo "	<TD width=\"100%\" style=\"padding-left:5px;padding-right:5px;word-break:break-all;\"><A HREF=\"".$Dir.FrontDir."productdetail.php?productcode=".$row->productcode."\" onmouseover=\"window.status='상품상세조회';return true;\" onmouseout=\"window.status='';return true;\"><FONT class=\"prname\">".viewproductname($row->productname,$row->etctype,$row->selfcode)."</FONT></A>";
				...
				if($reserveconv>0) {
					echo "<br><img src=\"".$Dir."images/common/reserve_icon.gif\" border=\"0\" style=\"margin-right:2px;\"><font class=\"prreserve\">".number_format($reserveconv)."원</font>";
				}
