...
?>
	...
	<tr>
		...
		<col></col>
		<tr>
			<td colspan="2" style="padding-left:10px;padding-bottom:5px;padding-top:5px;line-height:24px;color:#000000;font-size:15px;" class=choicecodename><b><?=($_cdata->code_name?$_cdata->code_name:$_bdata->brandname)?></b></td>
		</tr>
		<tr>
...
<?
		...
		while($row=mysql_fetch_object($result)) {
			...
			if ($i!=0 && $i%2!=0) {
				echo "<td align=\"center\"><img src=\"".$Dir."images/common/brandproduct/".$_bdata->list_type."/plist_skin_lineb.gif\" border=\"0\"></td>\n";
			}

			if ($i!=0 && $i%2==0) {
				echo "</tr><tr><td height=\"5\"></td></tr><tr><td height=\"1\" colspan=\"3\" background=\"".$Dir."images/common/brandproduct/".$_bdata->list_type."/plist_skin_line3.gif\"></td></tr><tr><td height=\"5\"></td></tr>\n";
			}
			echo "<td>\n";
			...
			echo "	<TD style=\"padding-left:5px;padding-right:5px;\" style=\"word-break:break-all;\"><A HREF=\"".$Dir.FrontDir."productdetail.php?".$brand_link."productcode=".$row->productcode.$add_query."&sort=".$sort."\" onmouseover=\"window.status='상품상세조회';return true;\" onmouseout=\"window.status='';return true;\"><FONT class=\"prname\">".viewproductname($row->productname,$row->etctype,$row->selfcode)."</FONT></A>";
