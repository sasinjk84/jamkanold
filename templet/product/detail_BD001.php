...
?>
				...
				<table cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td><font color="#333333" style="font-size:15px;letter-spacing:-0.5pt;word-break:break-all;"><b><?=viewproductname($_pdata->productname,$_pdata->etctype,"")?></b></font></td>
				</tr>
				<tr>
					<td height="5"></td>
				</tr>
...
?>
		...
		<tr>
			...
			<table cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td><a href="#1"><img src="<?=$Dir?>images/common/product/<?=$_cdata->detail_type?>/pdetail_skin_detailtitle1.gif" border="0"></td>
...
<?
	...
	if(strlen($deli_info)>0) {
		...
		echo "		<table cellpadding=\"0\" cellspacing=\"0\" width=\"100%\">\n";
		echo "		<tr>\n";
		echo "			<td><a href=\"#1\"><img src=\"".$Dir."images/common/product/".$_cdata->detail_type."/pdetail_skin_detailtitle1ra.gif\" border=\"0\"></td>\n";
		echo "			<td><a href=\"#2\"><img src=\"".$Dir."images/common/product/".$_cdata->detail_type."/pdetail_skin_detailtitle2ra.gif\" border=\"0\"></a></td>\n";
		echo "			<td><a href=\"#3\"><img src=\"".$Dir."images/common/product/".$_cdata->detail_type."/pdetail_skin_detailtitle3.gif\" border=\"0\"></a></td>\n";
		echo "			<td><a href=\"#4\"><img src=\"".$Dir."images/common/product/".$_cdata->detail_type."/pdetail_skin_detailtitle4r.gif\" border=\"0\"></a></td>\n";
		echo "			<td><a href=\"#5\"><img src=\"".$Dir."images/common/product/".$_cdata->detail_type."/pdetail_skin_detailtitle5r.gif\" border=\"0\"></a></td>\n";
		echo "			<td width=\"100%\" background=\"".$Dir."images/common/product/".$_cdata->detail_type."/pdetail_skin_detailtitlebg.gif\"></td>\n";
		echo "		</tr>\n";
...
?>
		...
		<tr>
			...
			<tr>
				...
				<tr>
					...
					<td><a href="#2"><img src="<?=$Dir?>images/common/product/<?=$_cdata->detail_type?>/pdetail_skin_detailtitle2r.gif" border="0"></a></td>
					<td><a href="#3"><img src="<?=$Dir?>images/common/product/<?=$_cdata->detail_type?>/pdetail_skin_detailtitle3ra.gif" border="0"></a></td>
					<td><a href="#4"><img src="<?=$Dir?>images/common/product/<?=$_cdata->detail_type?>/pdetail_skin_detailtitle4.gif" border="0"></a></td>
					<td><a href="#5"><img src="<?=$Dir?>images/common/product/<?=$_cdata->detail_type?>/pdetail_skin_detailtitle5r.gif" border="0"></a></td>
					<td width="100%" background="<?=$Dir?>images/common/product/<?=$_cdata->detail_type?>/pdetail_skin_detailtitlebg.gif"></td>
				</tr>
				</table>
		...
		<tr>
			...
			<tr>
				...
				<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td><a href="#1"><img src="<?=$Dir?>images/common/product/<?=$_cdata->detail_type?>/pdetail_skin_detailtitle1r.gif" border="0"></td>
					<td><a href="#2"><img src="<?=$Dir?>images/common/product/<?=$_cdata->detail_type?>/pdetail_skin_detailtitle2r.gif" border="0"></a></td>
					<td><a href="#3"><img src="<?=$Dir?>images/common/product/<?=$_cdata->detail_type?>/pdetail_skin_detailtitle3r.gif" border="0"></a></td>
					<td><a href="#4"><img src="<?=$Dir?>images/common/product/<?=$_cdata->detail_type?>/pdetail_skin_detailtitle4r.gif" border="0"></a></td>
					<td><a href="#5"><img src="<?=$Dir?>images/common/product/<?=$_cdata->detail_type?>/pdetail_skin_detailtitle5.gif" border="0"></a></td>
					<td width="100%" background="<?=$Dir?>images/common/product/<?=$_cdata->detail_type?>/pdetail_skin_detailtitlebg.gif"></td>
				</tr>
				</table>
				</td>
