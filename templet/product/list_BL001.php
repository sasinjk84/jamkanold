...
<?
			...
			while($row=mysql_fetch_object($result)) {
				...
				if($i>0 && $i%3==0) echo "</tr><tr><td colspan=\"3\" height=\"1\" background=\"".$Dir."images/common/product/".$_cdata->list_type."/plist_skin_table01.gif\"></td></tr><tr><td height=\"8\"></td></tr><tr>\n";
?>
			<td valign="top" width="33%">
			<table width="100%" cellpadding="0" cellspacing="0" id="G<?=$row->productcode?>" onmouseover="quickfun_show(this,'G<?=$row->productcode?>','')" onmouseout="quickfun_show(this,'G<?=$row->productcode?>','none')">
			<tr>
...
?>
					...
					<tr>
						<td align="center" style="word-break:break-all;"><A HREF="<?=$Dir.FrontDir?>productdetail.php?productcode=<?=$row->productcode.$add_query?>&sort=<?=$sort?>" onmouseover="window.status='상품상세조회';return true;" onmouseout="window.status='';return true;"><IMG SRC="<?=$Dir?>images/common/product/<?=$_cdata->list_type?>/plist_skin_gong_view.gif" border="0"></a></td>
					</tr>
					</table>
					</td>
					<td></td>
