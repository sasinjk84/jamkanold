...
?>
	...
	<tr>
		...
		<tr height="30" bgcolor="#F8F8F8" align="center">
			<td colspan="2"><font color="#000000">제품사진</font></td>
			<td><font color="#000000">제품명</font></td>
			<td><font color="#000000">가격변동표</font></td>
			<td><font color="#000000">시중가격</font></td>
			<td><font color="#000000">판매가격</font></td>
			<td><font color="#000000">남은수량</font></td>
		</tr>
<?
		//번호, 사진, 상품명, 제조사, 가격
...
?>
		...
		<tr align="center" id="G<?=$row->productcode?>" onmouseover="quickfun_show(this,'G<?=$row->productcode?>','','row')" onmouseout="quickfun_show(this,'G<?=$row->productcode?>','none')">
			<td style="padding-top:1px;padding-bottom:1px;"><A HREF="<?=$Dir.FrontDir?>productdetail.php?productcode=<?=$row->productcode.$add_query?>&sort=<?=$sort?>" onmouseover="window.status='상품상세조회';return true;" onmouseout="window.status='';return true;">
<?
					if (strlen($row->tinyimage)>0 && file_exists($Dir.DataDir."shopimages/product/".$row->tinyimage)==true) {
...
?>
			...
			<td align="left" style="padding-left:5px;padding-right:5px;word-break:break-all;"><a href='<?=$Dir.FrontDir?>productdetail.php?productcode=<?=$row->productcode.$add_query?>&sort=<?=$sort?>' onmouseover="window.status='상품상세조회';return true;" onmouseout="window.status='';return true;"><font color="#000000" style="font-size:11px;letter-spacing:-0.5pt;"><b><?=viewselfcode($row->productname,$row->selfcode)?></b></font></a>
<?
			if($_data->ETCTYPE["TAGTYPE"]=="Y") {
				$taglist=explode(",",$row->tag);
				$jj=0;
...
?>
			...
			<TD style="word-break:break-all;" class="prprice"><img src="<?=$Dir?>images/common/won_icon2.gif" border="0" style="margin-right:2px;"><s><?=number_format($row->consumerprice)?>원</s></td>
			<TD style="word-break:break-all;" class="prprice"><img src="<?=$Dir?>images/common/won_icon.gif" border="0" style="margin-right:2px;"><font color="#F02800" style="font-size:11px;letter-spacing:-0.5pt;"><b><?=number_format($row->sellprice)?>원</b></font></td>
