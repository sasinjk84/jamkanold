...
<?
			...
			while($row=mysql_fetch_object($result)) {
				...
				if($i>0 && $i%3==0) {
					echo "</tr><tr><td height=\"5\"></td></tr><tr><td height=\"1\" colspan=\"5\" background=\"".$Dir."images/common/product/".$_cdata->list_type."/plist_skin_table01.gif\"></td><tr><td height=\"5\"></td></tr></tr>\n";
				}
?>
			<td valign="top">
...
?>
				...
				<tr>
					<td style="word-break:break-all;"><IMG SRC="<?=$Dir?>images/common/product/<?=$_cdata->list_type?>/plist_skin_communitynero.gif" border="0"><font style="font-size:11px;"> 현재가 : <font color="#F02800" style="letter-spacing:-0.5pt;"><b><?=number_format($row->sellprice)?></b>원</font></td>
				</tr>
