...
?>
					...
					<tr>
						<td align="center" style="word-break:break-all;"><A HREF="<?=$Dir.FrontDir?>productdetail.php?productcode=<?=$row->productcode.$add_query?>&sort=<?=$sort?>" onmouseover="window.status='상품상세조회';return true;" onmouseout="window.status='';return true;"><IMG SRC="<?=$Dir?>images/common/product/<?=$_cdata->list_type?>/plist_skin_gong_view.gif" border="0" vspace="5"></a></td>
					</tr>
					</table>
				</td>
