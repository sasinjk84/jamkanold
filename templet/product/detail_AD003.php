...
?>
				...
				<table cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td><font color="#9A1331" style="font-size:15px;letter-spacing:-0.5pt;word-break:break-all;"><b><?=viewproductname($_pdata->productname,$_pdata->etctype,"")?></b></font></td>
				</tr>
				<tr>
					<td height="5"></td>
				</tr>
				<tr>
					<td background="<?=$Dir?>images/common/product/<?=$_cdata->detail_type?>/pdetail_skin_titleline.gif" HEIGHT="3"></td>
				</tr>
				<tr>
					<td height="10"></td>
				</tr>
...
<?
				...
				if(strlen($dicker=dickerview($_pdata->etctype,number_format($_pdata->sellprice),1))>0) {
					...
					$prsellprice.="<td>판매가격</td>\n";
					$prsellprice.="<td></td>";
					//$prsellprice.="<td><img src=\"".$Dir."images/common/won_icon.gif\" border=\"0\" align=\"absmiddle\"><b><FONT color=\"#AA3344\" id=\"idx_price\">".number_format($_pdata->sellprice)."원</FONT></b></td>\n";
					...
					if($_pdata->assembleuse=="Y") {
						...
						$prsellprice.="<td>판매가격</td>\n";
						$prsellprice.="<td></td>";
						//$prsellprice.="<td><img src=\"".$Dir."images/common/won_icon.gif\" border=\"0\" align=\"absmiddle\"><b><FONT color=\"#AA3344\" id=\"idx_price\">".number_format(($miniq>1?$miniq*$_pdata->sellprice:$_pdata->sellprice))."원</FONT></b></td>\n";
				...
				$prquantity.="<tr>\n";
				$prquantity.="	<td width=\"33\"><input type=text name=\"quantity\" value=\"".($miniq>1?$miniq:"1")."\" size=\"4\" style=\"font-size:11px;BORDER:#DFDFDF 1px solid;HEIGHT:18px;BACKGROUND-COLOR:#F7F7F7;padding-top:2pt;padding-bottom:1pt;\"".(($_pdata->assembleuse=="Y" || substr($productcode,0,3)=='999')?" readonly":" onkeyup=\"strnumkeyup(this)\"")."></td>\n";
...
<?
				if(substr($productcode,0,3)=='999') {
					...
					if(strlen($_pdata->quantity)>0 && $_pdata->quantity<=0)
						echo "<FONT style=\"color:#AA3344;\"><b>품 절</b></FONT>";
					else {
						...
						echo "<a href=\"javascript:CheckForm('','".$opti."')\" onMouseOver=\"window.status='장바구니담기';return true;\"><IMG SRC=\"".$Dir."images/common/product/".$_cdata->detail_type."/pdetail_skin_btn02.gif\"  border=\"0\" align=middle></a>\n";
					}
...
?>
					<tr>
						...
						<tr>
							<td align="center" style="padding:3px;"><?=(strlen($dicker)>0?$dicker:"<img src=\"".$Dir."images/common/won_icon.gif\" border=\"0\" align=\"absmiddle\"><b><FONT color=\"#AA3344\" id=\"idx_price".$j."\">".number_format($SellpriceValue+$arrpackage_pricevalue[$j])."원</font></b>")?></td>
						</tr>
						</table>
						</td>
		...
		<tr>
			...
			<tr>
				...
				<div class="taginput">
					...
					<span style="font-size:8pt;letter-spacing:-1px;">* 한번에 하나의 태그만 넣어주세요 </span>
				</div>
				<ul class="tagtitle">
					<li>
...
<? if($_data->sns_ok == "Y" && $_pdata->sns_state == "Y"){?>
		...
		<tr>
			...
			<tr>
				...
				<table cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td><IMG SRC="<?=$Dir?>images/common/product/<?=$_cdata->detail_type?>/bar_detail_sns.gif" border="0"></td>
					<td width="100%" background="<?=$Dir?>images/common/product/<?=$_cdata->detail_type?>/pdetail_skin_write_bg.gif"></td>
					<td><IMG SRC="<?=$Dir?>images/common/product/<?=$_cdata->detail_type?>/pdetail_skin_write_img.gif" border="0"></td>
				</tr>
				</table>
...
?>
		...
		<tr>
			...
			<tr>
				...
				<table cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td><IMG SRC="<?=$Dir?>images/common/product/<?=$_cdata->detail_type?>/bar_detail_gonggu.gif" border="0"></td>
					<td width="100%" background="<?=$Dir?>images/common/product/<?=$_cdata->detail_type?>/pdetail_skin_write_bg.gif"></td>
					<td><IMG SRC="<?=$Dir?>images/common/product/<?=$_cdata->detail_type?>/pdetail_skin_write_img.gif" border="0"></td>
				</tr>
				</table>
