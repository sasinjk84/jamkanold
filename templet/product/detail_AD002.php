...
<?
				...
				for($i=0;$i<$prcnt;$i++) {
					if(substr($arexcel[$i],0,1)=="O") {	//공백
						echo "<tr><td colspan=\"4\" height=\"4\" bgcolor=\"#FFFFFF\"></td></tr>\n";
...
<?
	...
	if($_data->coll_loc=="1") {
		...
		echo "		<td width=\"100%\" border=\"0\" background=\"".$Dir."images/common/product/".$_cdata->detail_type."/pdetail_skin_relation_bg.gif\"></td>\n";
