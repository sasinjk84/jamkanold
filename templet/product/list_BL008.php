...
<?
			...
			while($row=mysql_fetch_object($result)) {
				...
				if($i>0 && $i%3==0) {
					echo "</tr><tr><td height=\"5\"></td></tr><tr><td height=\"1\" colspan=\"5\" background=\"".$Dir."images/common/product/".$_cdata->list_type."/plist_skin_table01.gif\"></td></tr><tr><td height=\"5\"></td></tr>\n";
				}
?>
			<td valign="top">
			<table cellpadding="0" cellspacing="0" width="100%" border="0" id="G<?=$row->productcode?>" onmouseover="quickfun_show(this,'G<?=$row->productcode?>','','row')" onmouseout="quickfun_show(this,'G<?=$row->productcode?>','none')">
			<col width=""></td>
			<col width="0"></td>
			<col width="50%"></td>
			<tr>
				...
				<table cellpadding="0" cellspacing="0" width="100%">
					<tr>
<?
						echo "<td align=\"center\"><A HREF=\"".$Dir.FrontDir."productdetail.php?productcode=".$row->productcode.$add_query."&sort=".$sort."\" onmouseover=\"window.status='상품상세조회';return true;\" onmouseout=\"window.status='';return true;\">";
						if (strlen($row->tinyimage)>0 && file_exists($Dir.DataDir."shopimages/product/".$row->tinyimage)==true) {
...
?>
				...
				<tr>
					<td style="word-break:break-all;"><IMG SRC="<?=$Dir?>images/common/product/<?=$_cdata->list_type?>/plist_skin_communitynero.gif" border="0"><font style="font-size:11px;"> 시중가 : <s><?=number_format($row->consumerprice)?>원</s></font></td>
				</tr>
				<tr>
					<td style="word-break:break-all;"><IMG SRC="<?=$Dir?>images/common/product/<?=$_cdata->list_type?>/plist_skin_communitynero.gif" border="0"><font style="font-size:11px;"> 현재가 : <font color="#F02800" style="letter-spacing:-0.5pt;"><b><?=number_format($row->sellprice)?>원</b></font></td>
				</tr>
				...
				<?}?>
				<tr>
					<td style="word-break:break-all;"><IMG SRC="<?=$Dir?>images/common/product/<?=$_cdata->list_type?>/plist_skin_communitynero.gif" border="0"><font style="font-size:11px;"> 남은수량 : 
					<?
				...
				<tr>
					...
					<tr>
						<td width="102">
						<table cellpadding="0" cellspacing="0" width="100%">
						<tr align="right" style="font-size:11px;">
							<td width="43" style="font-size:11px;">시작가<br></td>
							<td width="43" style="font-size:11px;">공구가</td>
						</tr>
						</table>
						</td>
					</tr>
