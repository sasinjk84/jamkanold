...
<tr>
	...
	<TABLE cellSpacing=0 cellPadding=0 width="95%" align="center">
		...
		<TR>
			<TD width="100%" height="30"><img src="<?=$Dir?>images/common/tag/<?=$_data->design_tag?>/tag_img01_head.gif"  border="0" align="absmiddle"><font color="#666666"><span style="font-size:8pt;">(집계기간 : <?=$start_date?>~<?=$end_date?>)</span></font></TD>
			<TD><A HREF="javascript:void(0)" onclick="tagCls.changeSort('name')" onmouseover="window.status='가나다순정렬';return true;" onmouseout="window.status='';return true;"><IMG SRC="<?=$Dir?>images/common/tag/<?=$_data->design_tag?>/tag_btn01.gif"  ALT=""></a></TD>
			<TD><A HREF="javascript:void(0)" onclick="tagCls.changeSort('best')" onmouseover="window.status='인기순정렬';return true;" onmouseout="window.status='';return true;"><IMG SRC="<?=$Dir?>images/common/tag/<?=$_data->design_tag?>/tag_btn02.gif" ALT=""></a></TD>
			</TR>
		<tr><td height=2 bgcolor=#dddddd colspan=3></td></TR>
			</TABLE>
