				...
				<tr>
					<td>
						<table cellpadding="0" cellspacing="0" width="100%" style="padding:0px 0px 20px 0px;">
							<tr>
								<td>* 고객게시판과 1:1맞춤상담을 통한 문의내역과 답변을 확인하실 수 있습니다.</td>
								<td style="padding-bottom:3px;text-align:right"><A HREF="javascript:PersonalWrite()" class="btn_gray"><span>문의하기</span></A></td>
							</tr>
						</table>
					</td>
				</tr>
...
<?
		...
		mysql_free_result($result);
		if ($cnt==0) {
			echo "<tr height=\"30\"><td colspan=\"5\" align=\"center\" style=\"padding:30px;\">문의내역이 없습니다.</td></tr>";
		}
?>
						</table>
					</td>
