...
<tr>
	...
	<tr>
		...
		<tr>
			<td colspan="3" height="6" background="<?=$Dir?>images/common/search/<?=$_data->design_search?>/design_search_skin7_t1.gif"></td>
		</tr>
		<tr>
			<td width="6" background="<?=$Dir?>images/common/search/<?=$_data->design_search?>/design_search_skin7_t2.gif"></td>
			<td background="<?=$Dir?>images/common/search/<?=$_data->design_search?>/design_search_skin7_tbg.gif" style="padding:15pt;">
			<table cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td><IMG SRC="<?=$Dir?>images/common/search/<?=$_data->design_search?>/design_search_skin7_text1.gif" border="0"></td>
				<td width="30" nowrap></td>
				<td width="100%">
				<table cellpadding="2" cellspacing="0" width="100%">
				<tr>
					<td><IMG SRC="<?=$Dir?>images/common/search/<?=$_data->design_search?>/design_search_skin7_icon1.gif" border="0"></td>
				...
				<tr>
					<td><IMG SRC="<?=$Dir?>images/common/search/<?=$_data->design_search?>/design_search_skin7_icon2.gif" border="0"></td>
				...
				<tr>
					<td><IMG SRC="<?=$Dir?>images/common/search/<?=$_data->design_search?>/design_search_skin7_icon3.gif" border="0"></td>
				...
				<td align="right"><a href="javascript:CheckForm();"><IMG SRC="<?=$Dir?>images/common/search/<?=$_data->design_search?>/design_search_skin7_icon4.gif" border="0"></a></td>
			</tr>
			</table>
			</td>
			<td width="6" background="<?=$Dir?>images/common/search/<?=$_data->design_search?>/design_search_skin7_t5.gif"></td>
		</tr>
		<tr>
			<td colspan="3" height="6" background="<?=$Dir?>images/common/search/<?=$_data->design_search?>/design_search_skin7_t3.gif"></td>
		</tr>
		</table>
	...
	<tr>
		...
		<table cellpadding="0" cellspacing="0" width="100%">
		<tr>
			<td><IMG SRC="<?=$Dir?>images/common/search/<?=$_data->design_search?>/design_search_skin7_sticon.gif" border="0"></td>
			<td width="100%" background="<?=$Dir?>images/common/search/<?=$_data->design_search?>/design_search_skin7_stibg.gif">
			<table cellpadding="0" cellspacing="0" width="100%">
			<tr>
...
<?
			...
			while($row=mysql_fetch_object($result)) {
				...
				if ($i!=0 && $i%2!=0) {
					echo "<td align=\"center\"><img src=\"".$Dir."images/common/search/".$_data->design_search."/design_search_skin7_lineb.gif\" border=\"0\"></td>\n";
				}

				if ($i!=0 && $i%2==0) {
					echo "</tr>	<tr><td height=\"5\"></td></tr><tr><td height=\"1\" colspan=\"3\" background=\"".$Dir."images/common/search/".$_data->design_search."/design_search_skin7_line.gif\"></td></tr>	<tr><td height=\"5\"></td></tr><tr>\n";
				}
				echo "<td>\n";
