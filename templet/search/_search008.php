...
<?
			...
			while($row=mysql_fetch_object($result)) {
				...
				if ($i!=0 && $i%2==0) {
					echo "</tr>	<tr><td height=\"5\"></td></tr><tr><td height=\"1\" colspan=\"3\" background=\"".$Dir."images/common/search/".$_data->design_search."/design_search_skin8_line.gif\"></td></tr>	<tr><td height=\"5\"></td></tr><tr>\n";
				}
				echo "<td>\n";
