...
<tr>
	...
	<tr>
		...
		<tr>
			<td><img src="<?=$Dir?>images/common/search/<?=$_data->design_search?>/design_search_skin9_t1.gif" border="0"></td>
			<td background="<?=$Dir?>images/common/search/<?=$_data->design_search?>/design_search_skin9_t1bg.gif" width="100%"></td>
			<td><img src="<?=$Dir?>images/common/search/<?=$_data->design_search?>/design_search_skin9_t4.gif" border="0"></td>
		</tr>
		<tr>
			<td background="<?=$Dir?>images/common/search/<?=$_data->design_search?>/design_search_skin9_t2bg.gif"><img src="<?=$Dir?>images/common/search/<?=$_data->design_search?>/design_search_skin9_t2bg.gif" border="0"></td>
			<td width="100%" style="padding:10px;">
			<table cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td><IMG SRC="<?=$Dir?>images/common/search/<?=$_data->design_search?>/design_search_skin9_text1.gif" border="0"></td>
				<td width="30" nowrap></td>
				<td width="100%">
				<table cellpadding="2" cellspacing="0" width="100%">
				<tr>
					<td><IMG SRC="<?=$Dir?>images/common/search/<?=$_data->design_search?>/design_search_skin9_icon1.gif" border="0"></td>
				...
				<tr>
					<td><IMG SRC="<?=$Dir?>images/common/search/<?=$_data->design_search?>/design_search_skin9_icon2.gif" border="0"></td>
				...
				<tr>
					<td><IMG SRC="<?=$Dir?>images/common/search/<?=$_data->design_search?>/design_search_skin9_icon3.gif" border="0"></td>
				...
				<td><a href="javascript:CheckForm();"><IMG SRC="<?=$Dir?>images/common/search/<?=$_data->design_search?>/design_search_skin9_icon4.gif" border="0"></a></td>
			</tr>
			</table>
			</td>
			<td background="<?=$Dir?>images/common/search/<?=$_data->design_search?>/design_search_skin9_t4bg.gif"><img src="<?=$Dir?>images/common/search/<?=$_data->design_search?>/design_search_skin9_t4bg.gif" border="0"></td>
		</tr>
		<tr>
			<td><img src="<?=$Dir?>images/common/search/<?=$_data->design_search?>/design_search_skin9_t2.gif" border="0"></td>
			<td background="<?=$Dir?>images/common/search/<?=$_data->design_search?>/design_search_skin9_t3bg.gif" width="100%"></td>
			<td><img src="<?=$Dir?>images/common/search/<?=$_data->design_search?>/design_search_skin9_t3.gif" border="0"></td>
		</tr>
		</table>
	...
	<tr>
		...
		<table cellpadding="0" cellspacing="0" width="100%">
		<tr>
			<td><IMG SRC="<?=$Dir?>images/common/search/<?=$_data->design_search?>/design_search_skin9_sticon.gif" border="0"></td>
			<td width="100%" background="<?=$Dir?>images/common/search/<?=$_data->design_search?>/design_search_skin9_stibg.gif">
			<table cellpadding="0" cellspacing="0" width="100%">
			<tr>
...
<?
			...
			while($row=mysql_fetch_object($result)) {
				...
				if ($i!=0 && $i%2!=0) {
					echo "<td align=\"center\"><img src=\"".$Dir."images/common/search/".$_data->design_search."/design_search_skin9_lineb.gif\" border=\"0\"></td>\n";
				}

				if ($i!=0 && $i%2==0) {
					echo "</tr>	<tr><td height=\"5\"></td></tr><tr><td height=\"1\" colspan=\"3\" background=\"".$Dir."images/common/search/".$_data->design_search."/design_search_skin9_line.gif\"></td></tr>	<tr><td height=\"5\"></td></tr><tr>\n";
				}
				echo "<td>\n";
				...
				echo "	<TD style=\"padding-left:5px;padding-right:5px;word-break:break-all;\"><A HREF=\"".$Dir.FrontDir."productdetail.php?productcode=".$row->productcode."\" onmouseover=\"window.status='상품상세조회';return true;\" onmouseout=\"window.status='';return true;\"><FONT class=\"prname\">".viewproductname($row->productname,$row->etctype,$row->selfcode)."</FONT>".(strlen($row->prmsg)?'<br><span class="prmsgArea">'.$row->prmsg.'</span>':'')."</A>\n";
