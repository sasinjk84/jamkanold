				...
				<TR bgColor="#fafafa" align="center">
					<TD>
						<TABLE border="0" cellSpacing="0" cellPadding="0" width="100%" style="table-layout:fixed">
							...
							<col width="100"></col>
							<tr>
								<td style="padding:5px;"><!--<textarea name=up_comment style="width:<?=$setup[comment_width]?>; height:70px; padding:5px; line-height:17px; border:solid 1px #BDBDBD; font-size:9pt; color:333333; background-color:white;"></textarea>--><textarea name=up_comment style="width:100%; height:70px; padding:5px; line-height:17px; border:solid 1px #BDBDBD; font-size:9pt; color:333333; background-color:white;"></textarea></td>
