...
* File Name     : pcc_V3_input_seed_v2
* Comment       : 
* History       : Version 2.0
**************************************************************************************************************************/
?>
...
<body onload="document.reqPCCForm.id.focus();" bgcolor="#FFFFFF" topmargin=0 leftmargin=0 marginheight=0 marginwidth=0>
        <center>
            ...
            <form name="reqPCCForm" method="post" action="./pcc_V3_sample_seed_v2.php">
                <table cellpadding=1 cellspacing=1>
                    <tr>
                        <td align=center>회원사아이디</td>
                        <td align=left><input type="text" name="id" size='41' maxlength ='8' value = "SRNN001"></td>
                    </tr>
                    <tr>
                        <td align=center>서비스번호</td>
                        <td align=left><input type="text" name="srvNo" size='41' maxlength ='6' value="001006"></td>
                    </tr>
                    <tr>
                        <td align=center>요청번호</td>
                        <td align=left><input type="text" name="reqNum" size='41' maxlength ='40' value="0000000000000000"></td>
                    </tr>
					<tr>
                    ...
                    <tr>
                        ...
                        <td align=left><input type="text" name="retUrl" size="41" value="32http://beta.jamkan.com/Siren24_v2/pcc_V3_popup_seed_v2.php"></td>
                    </tr>
                </table>
                <br><br>
