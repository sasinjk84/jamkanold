...
if($type=='insert'){
	...
	$onload="<script>alert('배송지 등록이 완료되었습니다.');window.opener.location.reload();self.close();</script>";
}
?>
<HTML>
	<HEAD>
...
<body style="margin:0;padding:0">
	<div style="background:#000;color:#fff;overflow:hidden">
		<h4 style="margin:0;padding:0;height:40px;line-height:40px;float:left;padding-left:20px;box-sizing:border-box">배송지 등록</h4>
	...
	<div style="margin:0 auto;padding:30px;box-sizing:border-box;background:#fff;border:1px solid #ddd;list-style:none">
		...
		<form name="form1" id="form1" action="<?=$_SERVER[PHP_SELF]?>" method="post">
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				...
				<tr>
					<th>수신자명</th>
					<td style="padding:5px 10px;"><input type="text" name="receiver_name" maxlength="10" class="input" style="width:44%;" /></td>
				</tr>
				<tr>
					<th>전화번호</th>
					<td style="padding:5px 10px;">
						<input type="text" name="receiver_tel11" maxlength="4" class="input" style="width:20%;" /> - 
						<input type="text" name="receiver_tel12" maxlength="4" class="input" style="width:20%;" /> - 
						<input type="text" name="receiver_tel13" maxlength="4" class="input" style="width:20%;" />
					</td>
				</tr>
				<tr>
					<th>휴대폰번호</th>
					<td style="padding:5px 10px;">
						<input type="text" name="receiver_tel21" maxlength="4" class="input" style="width:20%;" /> - 
						<input type="text" name="receiver_tel22" maxlength="4" class="input" style="width:20%;" /> - 
						<input type="text" name="receiver_tel23" maxlength="4" class="input" style="width:20%;" />
					</td>
				</tr>
				<tr>
					<th>이메일</th>
					<td style="padding:5px 10px;"><input type="text" name="receiver_email" maxlength="40" class="input" style="width:100%;" /></td>
				</tr>
				<tr>
					<th>주소</th>
					<td style="padding:5px 10px;">
    ...
    margin: 0px 1px 0px 0px;"><span class="btn_s_line2">주소검색</span></a>
			...
			<div style="margin-top:20px;text-align:center;"><a href="#" onclick="CheckForm('insert','')" style="display: inline-block;
    padding: 6px;
    background: #ffffff;
    border: 1px solid #dddddd;
    border-radius: 1px;
    text-decoration: none;
    font-size: 12px;
    margin: 0px 1px 0px 0px;"><span class="btn_s_line2">배송지 등록하기</span></a></div>
		</form>
	</div>
