...
<tr>
	...
	<tr>
		...
		<?if($isregist==true){?>
			...
			<div>
			<strong><span style="color:red">( <?=$brand_name?> )</span> 미니샵을 찜한 쇼핑몰로 등록되었습니다.</strong>
			<p style="line-height:14pt;color:#585858">
				...
				찜한 쇼핑몰에서 보내는 메일 수신을 원하실 경우<br />‘마이페이지 > 찜한 쇼핑몰’에서 변경 하실 수 있습니다.
				<?}?>
			</p>
			</div>
			...
			<div>
			<strong><span style="color:red">( <?=$brand_name?> )</span> 미니샵은 이미 찜한 쇼핑몰로 등록 되었습니다.</strong>
			</div>
		...
		<div>
		<strong><span style="color:red">( <?=$brand_name?> )</span> 미니샵을 찜한 쇼핑몰로 등록 합니다.</strong>
		<p style="line-height:14pt;color:#585858">
			찜한 쇼핑몰로 등록 하시면 판매자의 이벤트나 <br />
