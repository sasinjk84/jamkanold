	...
	<tr>
		...
		<tr>
			...
			<tr height=35 valign=middle>
				...
				<td style="padding-left:5px"><B><?=$SBinfo->s_master?></B></td>
			</tr>
			<tr height=35 valign=middle>
...
<div style="border:2px solid red; position:absolute;left:250px;top:200px;padding:10px 30px;color:red; font-size:20px;font-weight:bold;filter:alpha(opacity=90); background:#fff;"><?=$document_status[$documet_result_array[0]["now_state"]]?></div>
</body>
</html>