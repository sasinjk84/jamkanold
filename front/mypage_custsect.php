...
<HTML>
<HEAD>
<TITLE><?=$_data->shoptitle?> - 찜한 쇼핑몰</TITLE>
...
<div class="currentTitle">
	<div class="titleimage">찜한 쇼핑몰</div>
	<!--<div class="current"><img src="/data/design/img/sub/icon_home.gif" border="0" alt="" /> 홈 &gt; 마이페이지 &gt; <SPAN class="nowCurrent">찜한 쇼핑몰</span></div>-->
</div>
<!-- 마이페이지-단골매장 상단 메뉴 -->
...
if ($leftmenu!="N") {
	...
	if ($_data->title_type=="Y" && file_exists($Dir.DataDir."design/mycustsect_title.gif")) {
		echo "<td><img src=\"".$Dir.DataDir."design/mycustsect_title.gif\" border=\"0\" alt=\"찜한 쇼핑몰\"></td>\n";
	} else {
		echo "<td>\n";
		/*
