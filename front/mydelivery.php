...
<body topmargin="0" leftmargin="0" rightmargin="0" marginheight="0" marginwidth="0" oncontextmenu="return false;">
	...
	<ul style="width:92%;margin:20px auto;">
		...
		<li>- 주소정보 수정/삭제는 [마이페이지 > 배송지관리]에서 가능합니다.</li>
	</ul>
	<table cellpadding="0" cellspacing="0" width="92%" class="itemListTbl" style="margin:0 auto;">
		...
		<?
			...
			while($row=mysql_fetch_object($result)) {
				...
				echo "	<td class=\"tdstyle2a\"><a href=\"javascript:choice_addr('".$name."','".$tel11."','".$tel12."','".$tel13."','".$tel21."','".$tel22."','".$tel23."','".$email."','".$post."','".$receiver_addr1."','".$receiver_addr2."');\"><span class=\"btn_m_gray\" style='width:100%;box-sizing:border-box;'>선택</span></a></td>\n";
				echo "</tr>\n";
