...
<?
	...
	$dec_retInfo = exec("/home/rental/public_html/Siren24/SciSecuX SEED 2 0 $iv $enc_retInfo ");//암호화모듈 설치시 생성된 SciSecuX 파일이 있는 리눅스 경로를 설정해주세요.
...
<?
	...
	$hmac_str = exec("/home/rental/public_html/Siren24/SciSecuX HMAC 1 0 $encPara ");
...
?>
		...
		<a href="http://beta.jamkan.com/Siren24/pcc_V3_input_seed.php">[Back]</a>
<?
		exit;
	}
	...
	$decPara = exec("/home/rental/public_html/Siren24/SciSecuX SEED 2 0 $iv $encPara ");
