...
<body onload="document.reqPCCForm.id.focus();" bgcolor="#FFFFFF" topmargin=0 leftmargin=0 marginheight=0 marginwidth=0>
        <center>
            ...
            <form name="reqPCCForm" method="post" action="./pcc_V3_sample_seed.php">
                <table cellpadding=1 cellspacing=1>
                    ...
                    <tr>
                        ...
                        <td align=left><input type="text" name="srvNo" size='41' maxlength ='6' value="001005"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td align=left><input type="text" name="retUrl" size="41" value="32http://beta.jamkan.com/Siren24/pcc_V3_popup_seed.php"></td>
                    </tr>
                </table>
                <br><br>
